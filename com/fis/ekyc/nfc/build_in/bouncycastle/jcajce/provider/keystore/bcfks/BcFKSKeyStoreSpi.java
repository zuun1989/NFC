...
class BcFKSKeyStoreSpi extends KeyStoreSpi {
    ...
    public static class SharedKeyStoreSpi extends BcFKSKeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers {
        ...
        private byte[] calculateMac(String str, char[] cArr) throws NoSuchAlgorithmException, InvalidKeyException {
            byte[] concatenate;
            if (cArr != null) {
                concatenate = Arrays.concatenate(Strings.toUTF8ByteArray(cArr), Strings.toUTF8ByteArray(str));
            } else {
                concatenate = Arrays.concatenate(this.seedKey, Strings.toUTF8ByteArray(str));
            }
            return SCrypt.generate(concatenate, this.seedKey, 16384, 8, 1, 32);
        }
    ...
    private EncryptedPrivateKeyData createPrivateKeySequence(EncryptedPrivateKeyInfo encryptedPrivateKeyInfo, Certificate[] certificateArr) throws CertificateEncodingException {
        com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x509.Certificate[] certificateArr2 = new com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x509.Certificate[certificateArr.length];
        for (int i = 0; i != certificateArr.length; i++) {
            certificateArr2[i] = com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x509.Certificate.getInstance(certificateArr[i].getEncoded());
        }
    ...
    private Certificate decodeCertificate(Object obj) {
        ...
        if (jcaJceHelper != null) {
            try {
                return jcaJceHelper.createCertificateFactory("X.509").generateCertificate(new ByteArrayInputStream(com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x509.Certificate.getInstance(obj).getEncoded()));
            } catch (Exception unused) {
                return null;
            }
        } else {
            try {
                return CertificateFactory.getInstance("X.509").generateCertificate(new ByteArrayInputStream(com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x509.Certificate.getInstance(obj).getEncoded()));
    ...
    public java.security.cert.Certificate[] engineGetCertificateChain(java.lang.String r5) {
        /*
            r4 = this;
            java.util.Map<java.lang.String, com.fis.ekyc.nfc.build_in.bouncycastle.asn1.bc.ObjectData> r0 = r4.entries
            java.lang.Object r5 = r0.get(r5)
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.bc.ObjectData r5 = (com.fis.ekyc.nfc.build_in.bouncycastle.asn1.bc.ObjectData) r5
        ...
        L_0x0022:
            byte[] r5 = r5.getData()
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.bc.EncryptedPrivateKeyData r5 = com.fis.ekyc.nfc.build_in.bouncycastle.asn1.bc.EncryptedPrivateKeyData.getInstance(r5)
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x509.Certificate[] r5 = r5.getCertificateChain()
            int r0 = r5.length
        ...
        L_0x0040:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bcfks.BcFKSKeyStoreSpi.engineGetCertificateChain(java.lang.String):java.security.cert.Certificate[]");
    }
            ...
            if (bCFKSLoadStoreParameter.getStoreSignatureKey() != null) {
                ...
                try {
                    ...
                    if (storeCertificates != null) {
                        ...
                        com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x509.Certificate[] certificateArr = new com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x509.Certificate[length];
                        for (int i = 0; i != length; i++) {
                            certificateArr[i] = com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x509.Certificate.getInstance(storeCertificates[i].getEncoded());
                        }
    ...
    private KeyDerivationFunc generatePkbdAlgorithmIdentifier(KeyDerivationFunc keyDerivationFunc, int i) {
        ASN1ObjectIdentifier aSN1ObjectIdentifier = MiscObjectIdentifiers.id_scrypt;
        if (aSN1ObjectIdentifier.equals((ASN1Primitive) keyDerivationFunc.getAlgorithm())) {
            ScryptParams instance = ScryptParams.getInstance(keyDerivationFunc.getParameters());
            byte[] bArr = new byte[instance.getSalt().length];
            getDefaultSecureRandom().nextBytes(bArr);
            return new KeyDerivationFunc(aSN1ObjectIdentifier, new ScryptParams(bArr, instance.getCostParameter(), instance.getBlockSize(), instance.getParallelizationParameter(), BigInteger.valueOf((long) i)));
        }
        PBKDF2Params instance2 = PBKDF2Params.getInstance(keyDerivationFunc.getParameters());
    ...
    public void engineLoad(InputStream inputStream, char[] cArr) throws IOException, NoSuchAlgorithmException, CertificateException {
        ...
        try {
            ...
            if (integrityCheck.getType() == 0) {
                ...
                try {
                    com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x509.Certificate[] certificates = instance3.getCertificates();
                    if (this.validator == null) {
                        verifySig(instance.getStoreData(), instance3, this.verificationKey);
                        ...
                        if (this.validator.isValid(x509CertificateArr)) {
                            verifySig(instance.getStoreData(), instance3, x509CertificateArr[0].getPublicKey());
                        } else {
    ...
    public void engineStore(OutputStream outputStream, char[] cArr) throws IOException, NoSuchAlgorithmException, CertificateException {
        if (this.creationDate != null) {
            ...
            if (MiscObjectIdentifiers.id_scrypt.equals((ASN1Primitive) this.hmacPkbdAlgorithm.getAlgorithm())) {
                this.hmacPkbdAlgorithm = generatePkbdAlgorithmIdentifier(this.hmacPkbdAlgorithm, ScryptParams.getInstance(this.hmacPkbdAlgorithm.getParameters()).getKeyLength().intValue());
            } else {
                this.hmacPkbdAlgorithm = generatePkbdAlgorithmIdentifier(this.hmacPkbdAlgorithm, PBKDF2Params.getInstance(this.hmacPkbdAlgorithm.getParameters()).getKeyLength().intValue());
            }
            try {
