...
import com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.dstu.KeyFactorySpi;
import com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.config.ConfigurableProvider;
import com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.util.AsymmetricAlgorithmProvider;

public class DSTU4145 {
    private static final String PREFIX = "com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.dstu.";

    public static class Mappings extends AsymmetricAlgorithmProvider {
        public void configure(ConfigurableProvider configurableProvider) {
            configurableProvider.addAlgorithm("KeyFactory.DSTU4145", "com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.dstu.KeyFactorySpi");
            ...
            configurableProvider.addAlgorithm("KeyPairGenerator.DSTU4145", "com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.dstu.KeyPairGeneratorSpi");
            ...
            configurableProvider.addAlgorithm("Signature.DSTU4145", "com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.dstu.SignatureSpi");
            ...
            addSignatureAlgorithm(configurableProvider, "GOST3411", "DSTU4145LE", "com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.dstu.SignatureSpiLe", aSN1ObjectIdentifier);
            addSignatureAlgorithm(configurableProvider, "GOST3411", "DSTU4145", "com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.dstu.SignatureSpi", aSN1ObjectIdentifier2);
        }
    }
}
