package com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc;
...
import com.fis.ekyc.nfc.build_in.bouncycastle.crypto.io.DigestInputStream;
import com.fis.ekyc.nfc.build_in.bouncycastle.crypto.io.DigestOutputStream;
import com.fis.ekyc.nfc.build_in.bouncycastle.crypto.io.MacInputStream;
import com.fis.ekyc.nfc.build_in.bouncycastle.crypto.io.MacOutputStream;
import com.fis.ekyc.nfc.build_in.bouncycastle.crypto.macs.HMac;
import com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.io.CipherInputStream;
import com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.io.CipherOutputStream;
...
import com.fis.ekyc.nfc.build_in.bouncycastle.util.io.TeeOutputStream;
...
public class BcKeyStoreSpi extends KeyStoreSpi implements BCKeyStore {
    ...
    public class StoreEntry {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:18:?, code lost:
            r2 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.access$100(r10.this$0, new java.io.DataInputStream(new com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.io.CipherInputStream(r2, r10.this$0.makePBECipher("BrokenPBEWithSHAAnd3-KeyTripleDES-CBC", 2, r11, r1, r9))));
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:?, code lost:
            ...
            r2.readFully(r1);
            r9 = r2.readInt();
            r2 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.access$100(r10.this$0, new java.io.DataInputStream(new com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.io.CipherInputStream(r2, r10.this$0.makePBECipher("OldPBEWithSHAAnd3-KeyTripleDES-CBC", 2, r11, r1, r9))));
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:23:0x00bd, code lost:
            ...
            r9.write(r7);
            r9.writeInt(r8);
            r11 = new java.io.DataOutputStream(new com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.io.CipherOutputStream(r9, r10.this$0.makePBECipher(com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.KEY_CIPHER, 1, r11, r7, r8)));
            com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.access$000(r10.this$0, r2, r11);
            r11.close();
        ...
        public java.lang.Object getObject(char[] r11) throws java.security.NoSuchAlgorithmException, java.security.UnrecoverableKeyException {
            ...
            L_0x000e:
                ...
                r2.<init>(r1)
                int r1 = r2.readInt()     // Catch:{ Exception -> 0x00fa }
                byte[] r7 = new byte[r1]     // Catch:{ Exception -> 0x00fa }
                r2.readFully(r7)     // Catch:{ Exception -> 0x00fa }
                int r8 = r2.readInt()     // Catch:{ Exception -> 0x00fa }
                com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi r3 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.this     // Catch:{ Exception -> 0x00fa }
                java.lang.String r4 = "PBEWithSHAAnd3-KeyTripleDES-CBC"
                r5 = 2
                r6 = r11
                javax.crypto.Cipher r1 = r3.makePBECipher(r4, r5, r6, r7, r8)     // Catch:{ Exception -> 0x00fa }
                com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.io.CipherInputStream r3 = new com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.io.CipherInputStream     // Catch:{ Exception -> 0x00fa }
                r3.<init>(r2, r1)     // Catch:{ Exception -> 0x00fa }
                com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi r1 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.this     // Catch:{ Exception -> 0x0049 }
                java.io.DataInputStream r2 = new java.io.DataInputStream     // Catch:{ Exception -> 0x0049 }
                r2.<init>(r3)     // Catch:{ Exception -> 0x0049 }
                java.security.Key r11 = r1.decodeKey(r2)     // Catch:{ Exception -> 0x0049 }
                return r11
            L_0x0049:
                java.io.ByteArrayInputStream r1 = new java.io.ByteArrayInputStream     // Catch:{ Exception -> 0x00fa }
                java.lang.Object r2 = r10.obj     // Catch:{ Exception -> 0x00fa }
                byte[] r2 = (byte[]) r2     // Catch:{ Exception -> 0x00fa }
                r1.<init>(r2)     // Catch:{ Exception -> 0x00fa }
                java.io.DataInputStream r2 = new java.io.DataInputStream     // Catch:{ Exception -> 0x00fa }
                r2.<init>(r1)     // Catch:{ Exception -> 0x00fa }
                int r1 = r2.readInt()     // Catch:{ Exception -> 0x00fa }
                byte[] r1 = new byte[r1]     // Catch:{ Exception -> 0x00fa }
                r2.readFully(r1)     // Catch:{ Exception -> 0x00fa }
                int r9 = r2.readInt()     // Catch:{ Exception -> 0x00fa }
                com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi r3 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.this     // Catch:{ Exception -> 0x00fa }
                ...
                r7 = r1
                r8 = r9
                javax.crypto.Cipher r3 = r3.makePBECipher(r4, r5, r6, r7, r8)     // Catch:{ Exception -> 0x00fa }
                com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.io.CipherInputStream r4 = new com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.io.CipherInputStream     // Catch:{ Exception -> 0x00fa }
                r4.<init>(r2, r3)     // Catch:{ Exception -> 0x00fa }
                com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi r2 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.this     // Catch:{ Exception -> 0x0083 }
                java.io.DataInputStream r3 = new java.io.DataInputStream     // Catch:{ Exception -> 0x0083 }
                r3.<init>(r4)     // Catch:{ Exception -> 0x0083 }
                java.security.Key r2 = r2.decodeKey(r3)     // Catch:{ Exception -> 0x0083 }
            L_0x0080:
                r7 = r1
                r8 = r9
                goto L_0x00bb
            L_0x0083:
                ...
                com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.io.CipherInputStream r4 = new com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.io.CipherInputStream     // Catch:{ Exception -> 0x00fa }
                r4.<init>(r2, r3)     // Catch:{ Exception -> 0x00fa }
                com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi r2 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.this     // Catch:{ Exception -> 0x00fa }
                java.io.DataInputStream r3 = new java.io.DataInputStream     // Catch:{ Exception -> 0x00fa }
                r3.<init>(r4)     // Catch:{ Exception -> 0x00fa }
                java.security.Key r2 = r2.decodeKey(r3)     // Catch:{ Exception -> 0x00fa }
                goto L_0x0080
            L_0x00bb:
                if (r2 == 0) goto L_0x00f4
                java.io.ByteArrayOutputStream r1 = new java.io.ByteArrayOutputStream     // Catch:{ Exception -> 0x00fa }
                r1.<init>()     // Catch:{ Exception -> 0x00fa }
                java.io.DataOutputStream r9 = new java.io.DataOutputStream     // Catch:{ Exception -> 0x00fa }
                r9.<init>(r1)     // Catch:{ Exception -> 0x00fa }
                int r3 = r7.length     // Catch:{ Exception -> 0x00fa }
                r9.writeInt(r3)     // Catch:{ Exception -> 0x00fa }
                r9.write(r7)     // Catch:{ Exception -> 0x00fa }
                r9.writeInt(r8)     // Catch:{ Exception -> 0x00fa }
                com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi r3 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.this     // Catch:{ Exception -> 0x00fa }
                java.lang.String r4 = "PBEWithSHAAnd3-KeyTripleDES-CBC"
                r5 = 1
                r6 = r11
                javax.crypto.Cipher r11 = r3.makePBECipher(r4, r5, r6, r7, r8)     // Catch:{ Exception -> 0x00fa }
                com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.io.CipherOutputStream r3 = new com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.io.CipherOutputStream     // Catch:{ Exception -> 0x00fa }
                r3.<init>(r9, r11)     // Catch:{ Exception -> 0x00fa }
                java.io.DataOutputStream r11 = new java.io.DataOutputStream     // Catch:{ Exception -> 0x00fa }
                r11.<init>(r3)     // Catch:{ Exception -> 0x00fa }
                com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi r3 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.this     // Catch:{ Exception -> 0x00fa }
                r3.encodeKey(r2, r11)     // Catch:{ Exception -> 0x00fa }
                r11.close()     // Catch:{ Exception -> 0x00fa }
                byte[] r11 = r1.toByteArray()     // Catch:{ Exception -> 0x00fa }
                r10.obj = r11     // Catch:{ Exception -> 0x00fa }
                return r2
            L_0x00f4:
                java.security.UnrecoverableKeyException r11 = new java.security.UnrecoverableKeyException     // Catch:{ Exception -> 0x00fa }
                r11.<init>(r0)     // Catch:{ Exception -> 0x00fa }
                throw r11     // Catch:{ Exception -> 0x00fa }
            L_0x00fa:
            ...
            L_0x0100:
                ...
                throw r11
            */
            throw new UnsupportedOperationException("Method not decompiled: com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.StoreEntry.getObject(char[]):java.lang.Object");
        }
        ...
        public StoreEntry(String str, Date date2, int i, Object obj2) {
            new Date();
            this.alias = str;
            this.date = date2;
            this.type = i;
        ...
        public StoreEntry(String str, Date date2, int i, Object obj2, Certificate[] certificateArr) {
            new Date();
            this.alias = str;
            this.date = date2;
            this.type = i;
    ...
    public void loadStore(InputStream inputStream) throws IOException {
        ...
        for (int read = dataInputStream.read(); read > 0; read = dataInputStream.read()) {
            ...
            if (read == 1) {
                this.table.put(readUTF, new StoreEntry(readUTF, date, 1, (Object) decodeCertificate(dataInputStream)));
            } else if (read == 2) {
