...
import com.fis.ekyc.nfc.build_in.bouncycastle.crypto.digests.SkeinDigest;
import com.fis.ekyc.nfc.build_in.bouncycastle.crypto.macs.HMac;
import com.fis.ekyc.nfc.build_in.bouncycastle.crypto.macs.SkeinMac;
...
public class Skein {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        private void addSkeinMacAlgorithm(ConfigurableProvider configurableProvider, int i, int i2) {
            ...
            sb3.append(str);
            configurableProvider.addAlgorithm(sb3.toString(), str2 + "$SkeinMacKeyGenerator_" + i + "_" + i2);
