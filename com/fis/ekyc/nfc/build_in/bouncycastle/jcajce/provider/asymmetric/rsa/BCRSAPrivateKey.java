...
public class BCRSAPrivateKey implements RSAPrivateKey, PKCS12BagAttributeCarrier {
    ...
    public byte[] getEncoded() {
        ...
        return KeyUtil.getEncodedPrivateKeyInfo(algorithmIdentifier2, new com.fis.ekyc.nfc.build_in.bouncycastle.asn1.pkcs.RSAPrivateKey(modulus2, bigInteger, privateExponent2, bigInteger2, bigInteger2, bigInteger2, bigInteger2, bigInteger2));
    }
    ...
    public BCRSAPrivateKey(AlgorithmIdentifier algorithmIdentifier2, RSAKeyParameters rSAKeyParameters) {
    ...
    public BCRSAPrivateKey(AlgorithmIdentifier algorithmIdentifier2, com.fis.ekyc.nfc.build_in.bouncycastle.asn1.pkcs.RSAPrivateKey rSAPrivateKey) {
        AlgorithmIdentifier algorithmIdentifier3 = BCRSAPublicKey.DEFAULT_ALGORITHM_IDENTIFIER;
        this.algorithmIdentifierEnc = getEncoding(algorithmIdentifier3);
        this.algorithmIdentifier = algorithmIdentifier3;
        this.algorithmIdentifier = algorithmIdentifier2;
