...
public class CertificateFactory extends CertificateFactorySpi {
    ...
    private Certificate getCertificate(ASN1Sequence aSN1Sequence) throws CertificateParsingException {
        ...
        if (aSN1Sequence.size() <= 1 || !(aSN1Sequence.getObjectAt(0) instanceof ASN1ObjectIdentifier) || !aSN1Sequence.getObjectAt(0).equals(PKCSObjectIdentifiers.signedData)) {
            return new X509CertificateObject(this.bcHelper, com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x509.Certificate.getInstance(aSN1Sequence));
        }
    ...
    private Certificate getCertificate() throws CertificateParsingException {
        ...
        while (this.sDataObjectCount < this.sData.size()) {
            ...
            if (objectAt instanceof ASN1Sequence) {
                return new X509CertificateObject(this.bcHelper, com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x509.Certificate.getInstance(objectAt));
            }
        }
        return null;
    }
