...
public class EC5Util {
    ...
    public static ECParameterSpec convertSpec(EllipticCurve ellipticCurve, com.fis.ekyc.nfc.build_in.bouncycastle.jce.spec.ECParameterSpec eCParameterSpec) {
    ...
    public static java.security.spec.ECParameterSpec convertToSpec(com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x9.X962Parameters r8, com.fis.ekyc.nfc.build_in.bouncycastle.math.ec.ECCurve r9) {
        /*
            boolean r0 = r8.isNamedCurve()
            if (r0 == 0) goto L_0x0048
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ASN1Primitive r8 = r8.getParameters()
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ASN1ObjectIdentifier r8 = (com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ASN1ObjectIdentifier) r8
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x9.X9ECParameters r0 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.util.ECUtil.getNamedCurveByOid(r8)
            if (r0 != 0) goto L_0x0024
            com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.config.ProviderConfiguration r1 = com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.BouncyCastleProvider.CONFIGURATION
        ...
        L_0x0024:
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.jce.spec.ECNamedCurveSpec r9 = new com.fis.ekyc.nfc.build_in.bouncycastle.jce.spec.ECNamedCurveSpec
            java.lang.String r3 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.util.ECUtil.getCurveName(r8)
        ...
        L_0x0051:
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ASN1Primitive r8 = r8.getParameters()
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ASN1Sequence r8 = com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ASN1Sequence.getInstance(r8)
            int r0 = r8.size()
            r1 = 3
            if (r0 <= r1) goto L_0x009f
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x9.X9ECParameters r8 = com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x9.X9ECParameters.getInstance(r8)
            byte[] r0 = r8.getSeed()
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.math.ec.ECPoint r1 = r8.getG()
        ...
        L_0x008c:
            ...
            goto L_0x00d9
        L_0x009f:
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.cryptopro.GOST3410PublicKeyAlgParameters r8 = com.fis.ekyc.nfc.build_in.bouncycastle.asn1.cryptopro.GOST3410PublicKeyAlgParameters.getInstance(r8)
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ASN1ObjectIdentifier r9 = r8.getPublicKeyParamSet()
            java.lang.String r9 = com.fis.ekyc.nfc.build_in.bouncycastle.asn1.cryptopro.ECGOST3410NamedCurves.getName(r9)
            com.fis.ekyc.nfc.build_in.bouncycastle.jce.spec.ECNamedCurveParameterSpec r9 = com.fis.ekyc.nfc.build_in.bouncycastle.jce.ECGOST3410NamedCurveTable.getParameterSpec(r9)
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ASN1ObjectIdentifier r8 = r8.getPublicKeyParamSet()
            java.lang.String r3 = com.fis.ekyc.nfc.build_in.bouncycastle.asn1.cryptopro.ECGOST3410NamedCurves.getName(r8)
            com.fis.ekyc.nfc.build_in.bouncycastle.math.ec.ECPoint r8 = r9.getG()
            java.security.spec.ECPoint r5 = convertPoint(r8)
        ...
        L_0x00da:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.util.EC5Util.convertToSpec(com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x9.X962Parameters, com.fis.ekyc.nfc.build_in.bouncycastle.math.ec.ECCurve):java.security.spec.ECParameterSpec");
    }

    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v14, resolved type: java.lang.Object} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v4, resolved type: com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x9.X9ECParameters} */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static com.fis.ekyc.nfc.build_in.bouncycastle.math.ec.ECCurve getCurve(com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.config.ProviderConfiguration r2, com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x9.X962Parameters r3) {
        /*
            java.util.Set r0 = r2.getAcceptableNamedCurves()
            boolean r1 = r3.isNamedCurve()
            if (r1 == 0) goto L_0x003d
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ASN1Primitive r3 = r3.getParameters()
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ASN1ObjectIdentifier r3 = com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ASN1ObjectIdentifier.getInstance(r3)
        ...
        L_0x001f:
            ...
            throw r2
        L_0x0027:
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x9.X9ECParameters r0 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.util.ECUtil.getNamedCurveByOid(r3)
        ...
        L_0x003d:
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.jce.spec.ECParameterSpec r2 = r2.getEcImplicitlyCa()
            com.fis.ekyc.nfc.build_in.bouncycastle.math.ec.ECCurve r2 = r2.getCurve()
            goto L_0x007b
        L_0x004c:
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ASN1Primitive r2 = r3.getParameters()
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ASN1Sequence r2 = com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ASN1Sequence.getInstance(r2)
        ...
        L_0x006a:
            r3 = 0
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ASN1Encodable r2 = r2.getObjectAt(r3)
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ASN1ObjectIdentifier r2 = com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ASN1ObjectIdentifier.getInstance(r2)
            com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x9.X9ECParameters r2 = com.fis.ekyc.nfc.build_in.bouncycastle.asn1.cryptopro.ECGOST3410NamedCurves.getByOIDX9(r2)
            com.fis.ekyc.nfc.build_in.bouncycastle.math.ec.ECCurve r2 = r2.getCurve()
        L_0x007b:
            return r2
        L_0x007c:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.util.EC5Util.getCurve(com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.config.ProviderConfiguration, com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x9.X962Parameters):com.fis.ekyc.nfc.build_in.bouncycastle.math.ec.ECCurve");
    }
    ...
    public static ECDomainParameters getDomainParameters(ProviderConfiguration providerConfiguration, ECParameterSpec eCParameterSpec) {
        ...
        com.fis.ekyc.nfc.build_in.bouncycastle.jce.spec.ECParameterSpec ecImplicitlyCa = providerConfiguration.getEcImplicitlyCa();
    ...
    public static com.fis.ekyc.nfc.build_in.bouncycastle.jce.spec.ECParameterSpec convertSpec(ECParameterSpec eCParameterSpec) {
        ...
        return new com.fis.ekyc.nfc.build_in.bouncycastle.jce.spec.ECParameterSpec(convertCurve, convertPoint, order, valueOf, seed);
    }
