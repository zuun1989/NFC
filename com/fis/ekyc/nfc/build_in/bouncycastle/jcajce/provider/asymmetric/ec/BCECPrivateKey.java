...
public class BCECPrivateKey implements ECPrivateKey, com.fis.ekyc.nfc.build_in.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    private void populateFromPrivKeyInfo(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        com.fis.ekyc.nfc.build_in.bouncycastle.asn1.sec.ECPrivateKey instance2 = com.fis.ekyc.nfc.build_in.bouncycastle.asn1.sec.ECPrivateKey.getInstance(parsePrivateKey);
    ...
    public byte[] getEncoded() {
        ...
        ECParameterSpec eCParameterSpec = this.ecSpec;
        if (eCParameterSpec == null) {
            i = ECUtil.getOrderBitLength(this.configuration, (BigInteger) null, getS());
        } else {
            i = ECUtil.getOrderBitLength(this.configuration, eCParameterSpec.getOrder(), getS());
        }
        if (this.publicKey != null) {
            eCPrivateKey = new com.fis.ekyc.nfc.build_in.bouncycastle.asn1.sec.ECPrivateKey(i, getS(), this.publicKey, domainParametersFromName);
        } else {
            eCPrivateKey = new com.fis.ekyc.nfc.build_in.bouncycastle.asn1.sec.ECPrivateKey(i, getS(), (ASN1Encodable) domainParametersFromName);
        }
        try {
    ...
    public BCECPrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters, BCECPublicKey bCECPublicKey, com.fis.ekyc.nfc.build_in.bouncycastle.jce.spec.ECParameterSpec eCParameterSpec, ProviderConfiguration providerConfiguration) {
        this.algorithm = str;
        this.d = eCPrivateKeyParameters.getD();
        this.configuration = providerConfiguration;
        if (eCParameterSpec == null) {
