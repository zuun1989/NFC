...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v3, resolved type: com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECPublicKeyParameters} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v6, resolved type: com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECPublicKeyParameters} */
    ...
    private void initFromKey(java.security.Key r6, java.security.spec.AlgorithmParameterSpec r7) throws java.security.InvalidKeyException, java.security.InvalidAlgorithmParameterException {
        /*
            ...
            boolean r1 = r0 instanceof com.fis.ekyc.nfc.build_in.bouncycastle.crypto.agreement.ECMQVBasicAgreement
            java.lang.String r2 = " for initialisation"
            java.lang.String r3 = " key agreement requires "
            r4 = 0
            if (r1 == 0) goto L_0x00a5
            r5.mqvParameters = r4
            boolean r0 = r6 instanceof com.fis.ekyc.nfc.build_in.bouncycastle.jce.interfaces.MQVPrivateKey
            if (r0 != 0) goto L_0x0039
            boolean r1 = r7 instanceof com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.spec.MQVParameterSpec
        ...
        L_0x0016:
            ...
            r7.append(r0)
            r7.append(r3)
            java.lang.Class<com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.spec.MQVParameterSpec> r0 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.spec.MQVParameterSpec.class
        ...
        L_0x0039:
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.jce.interfaces.MQVPrivateKey r6 = (com.fis.ekyc.nfc.build_in.bouncycastle.jce.interfaces.MQVPrivateKey) r6
            java.security.PrivateKey r7 = r6.getStaticPrivateKey()
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.AsymmetricKeyParameter r7 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.util.ECUtil.generatePrivateKeyParameter(r7)
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECPrivateKeyParameters r7 = (com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECPrivateKeyParameters) r7
            java.security.PrivateKey r0 = r6.getEphemeralPrivateKey()
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.AsymmetricKeyParameter r0 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.util.ECUtil.generatePrivateKeyParameter(r0)
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.AsymmetricKeyParameter r6 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.ec.ECUtils.generatePublicKeyParameter(r6)
            r4 = r6
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECPublicKeyParameters r4 = (com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECPublicKeyParameters) r4
            goto L_0x0091
        L_0x0063:
            com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.spec.MQVParameterSpec r7 = (com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.spec.MQVParameterSpec) r7
            java.security.PrivateKey r6 = (java.security.PrivateKey) r6
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.AsymmetricKeyParameter r6 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.util.ECUtil.generatePrivateKeyParameter(r6)
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECPrivateKeyParameters r6 = (com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECPrivateKeyParameters) r6
            ...
            java.security.PublicKey r1 = r7.getEphemeralPublicKey()
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.AsymmetricKeyParameter r1 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.ec.ECUtils.generatePublicKeyParameter(r1)
            r4 = r1
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECPublicKeyParameters r4 = (com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECPublicKeyParameters) r4
        L_0x0088:
            r5.mqvParameters = r7
            ...
            r7 = r6
        L_0x0091:
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.MQVPrivateParameters r6 = new com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.MQVPrivateParameters
            r6.<init>(r7, r0, r4)
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECDomainParameters r7 = r7.getParameters()
            r5.parameters = r7
            java.lang.Object r7 = r5.agreement
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.agreement.ECMQVBasicAgreement r7 = (com.fis.ekyc.nfc.build_in.bouncycastle.crypto.agreement.ECMQVBasicAgreement) r7
            r7.init(r6)
            goto L_0x0145
        L_0x00a5:
            boolean r1 = r7 instanceof com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.spec.DHUParameterSpec
            if (r1 == 0) goto L_0x010f
            boolean r0 = r0 instanceof com.fis.ekyc.nfc.build_in.bouncycastle.crypto.agreement.ECDHCUnifiedAgreement
            if (r0 == 0) goto L_0x00ed
            com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.spec.DHUParameterSpec r7 = (com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.spec.DHUParameterSpec) r7
            java.security.PrivateKey r6 = (java.security.PrivateKey) r6
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.AsymmetricKeyParameter r6 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.util.ECUtil.generatePrivateKeyParameter(r6)
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECPrivateKeyParameters r6 = (com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECPrivateKeyParameters) r6
            java.security.PrivateKey r0 = r7.getEphemeralPrivateKey()
        ...
        L_0x00d2:
            ...
            byte[] r7 = r7.getUserKeyingMaterial()
            r5.ukmParameters = r7
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECDHUPrivateParameters r7 = new com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECDHUPrivateParameters
            r7.<init>(r6, r0, r4)
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECDomainParameters r6 = r6.getParameters()
            r5.parameters = r6
            java.lang.Object r6 = r5.agreement
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.agreement.ECDHCUnifiedAgreement r6 = (com.fis.ekyc.nfc.build_in.bouncycastle.crypto.agreement.ECDHCUnifiedAgreement) r6
            r6.init(r7)
            goto L_0x0145
        L_0x00ed:
            java.security.InvalidAlgorithmParameterException r6 = new java.security.InvalidAlgorithmParameterException
            ...
            r7.append(r0)
            java.lang.Class<com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.spec.DHUParameterSpec> r0 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.spec.DHUParameterSpec.class
            java.lang.String r0 = getSimpleName(r0)
            r7.append(r0)
            java.lang.String r7 = r7.toString()
            r6.<init>(r7)
        ...
        L_0x010f:
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.DerivationFunction r0 = r5.kdf
            if (r0 != 0) goto L_0x0124
            boolean r0 = r7 instanceof com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.spec.UserKeyingMaterialSpec
        ...
        L_0x0124:
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.AsymmetricKeyParameter r6 = com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.util.ECUtil.generatePrivateKeyParameter(r6)
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECPrivateKeyParameters r6 = (com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECPrivateKeyParameters) r6
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ECDomainParameters r0 = r6.getParameters()
            r5.parameters = r0
            boolean r0 = r7 instanceof com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.spec.UserKeyingMaterialSpec
            if (r0 == 0) goto L_0x013c
            com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.spec.UserKeyingMaterialSpec r7 = (com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.spec.UserKeyingMaterialSpec) r7
            byte[] r4 = r7.getUserKeyingMaterial()
        L_0x013c:
            r5.ukmParameters = r4
            java.lang.Object r7 = r5.agreement
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.BasicAgreement r7 = (com.fis.ekyc.nfc.build_in.bouncycastle.crypto.BasicAgreement) r7
            r7.init(r6)
        L_0x0145:
            return
        L_0x0146:
            ...
            r7.append(r0)
            r7.append(r3)
            java.lang.Class<com.fis.ekyc.nfc.build_in.bouncycastle.jce.interfaces.ECPrivateKey> r0 = com.fis.ekyc.nfc.build_in.bouncycastle.jce.interfaces.ECPrivateKey.class
            java.lang.String r0 = getSimpleName(r0)
            r7.append(r0)
            r7.append(r2)
            java.lang.String r7 = r7.toString()
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fis.ekyc.nfc.build_in.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi.initFromKey(java.security.Key, java.security.spec.AlgorithmParameterSpec):void");
    }
