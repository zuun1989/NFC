...
public class X509CertParser extends X509StreamParserSpi {
    ...
    private Certificate getCertificate() throws CertificateParsingException {
        ...
        while (this.sDataObjectCount < this.sData.size()) {
            ...
            if (objectAt instanceof ASN1Sequence) {
                return new X509CertificateObject(com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x509.Certificate.getInstance(objectAt));
            }
        }
        return null;
    }
    ...
    private Certificate readPEMCertificate(InputStream inputStream) throws IOException, CertificateParsingException {
        ...
        if (readPEMObject != null) {
            return new X509CertificateObject(com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x509.Certificate.getInstance(readPEMObject));
        }
        return null;
    }
