...
import com.fis.ekyc.nfc.build_in.bouncycastle.crypto.engines.TwofishEngine;
...
import com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.BrokenPBE;
...
public class BrokenJCEBlockCipher implements BrokenPBE {
    ...
    public void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
            ...
            if (algorithmParameterSpec == null) {
                ...
                if (algorithmParameterSpec instanceof IvParameterSpec) {
                    ...
                    if (rC2ParameterSpec.getIV() != null) {
                        parametersWithIV = rC2Parameters;
                        if (this.ivLength != 0) {
                            ParametersWithIV parametersWithIV3 = new ParametersWithIV(rC2Parameters, rC2ParameterSpec.getIV());
                    ...
                    if (rC5ParameterSpec.getWordSize() == 32) {
                        ...
                        if (rC5ParameterSpec.getIV() != null) {
                            parametersWithIV = rC5Parameters;
                            if (this.ivLength != 0) {
                                ParametersWithIV parametersWithIV4 = new ParametersWithIV(rC5Parameters, rC5ParameterSpec.getIV());
                                this.ivParam = parametersWithIV4;
                                keyParameter = parametersWithIV4;
                            }
                        }
                    } else {
        ...
        ParametersWithIV parametersWithIV5 = keyParameter;
        if (this.ivLength != 0) {
            boolean z = keyParameter instanceof ParametersWithIV;
            parametersWithIV5 = keyParameter;
            if (!z) {
                ...
                if (i == 1 || i == 3) {
                    ...
                    ParametersWithIV parametersWithIV6 = new ParametersWithIV(keyParameter, bArr);
