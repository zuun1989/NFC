...
import com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ocsp.OCSPRequest;
import com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ocsp.OCSPResponse;
import com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ocsp.Request;
...
import com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ocsp.Signature;
import com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ocsp.SingleResponse;
import com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ocsp.TBSRequest;
    ...
    public static OCSPResponse getOcspResponse(CertID certID, PKIXCertRevocationCheckerParameters pKIXCertRevocationCheckerParameters, URI uri, X509Certificate x509Certificate, List<Extension> list, JcaJceHelper jcaJceHelper) throws CertPathValidatorException {
        ...
        try {
            ...
            for (int i2 = 0; i2 != list.size(); i2++) {
                ...
                aSN1EncodableVector2.add(new com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x509.Extension(new ASN1ObjectIdentifier(extension.getId()), extension.isCritical(), value));
            }
            try {
