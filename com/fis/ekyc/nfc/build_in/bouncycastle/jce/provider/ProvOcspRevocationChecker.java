...
import com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ocsp.OCSPObjectIdentifiers;
...
import com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ocsp.ResponseBytes;
import com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ocsp.ResponseData;
import com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ocsp.RevokedInfo;
import com.fis.ekyc.nfc.build_in.bouncycastle.asn1.ocsp.SingleResponse;
...
import com.fis.ekyc.nfc.build_in.bouncycastle.asn1.x500.style.BCStrictStyle;
...
class ProvOcspRevocationChecker implements PKIXCertRevocationChecker {
    ...
    private static X509Certificate getSignerCert(BasicOCSPResponse basicOCSPResponse, X509Certificate x509Certificate, X509Certificate x509Certificate2, JcaJceHelper jcaJceHelper) throws NoSuchProviderException, NoSuchAlgorithmException {
        ...
        X500Name instance = X500Name.getInstance(x500NameStyle, (Object) responderID.getName());
        if (x509Certificate2 != null && instance.equals(X500Name.getInstance(x500NameStyle, (Object) x509Certificate2.getSubjectX500Principal().getEncoded()))) {
            return x509Certificate2;
        }
        if (x509Certificate == null || !instance.equals(X500Name.getInstance(x500NameStyle, (Object) x509Certificate.getSubjectX500Principal().getEncoded()))) {
            return null;
        }
        return x509Certificate;
    }
    ...
    private static boolean responderMatches(ResponderID responderID, X509Certificate x509Certificate, JcaJceHelper jcaJceHelper) throws NoSuchProviderException, NoSuchAlgorithmException {
        ...
        X500NameStyle x500NameStyle = BCStrictStyle.INSTANCE;
        return X500Name.getInstance(x500NameStyle, (Object) responderID.getName()).equals(X500Name.getInstance(x500NameStyle, (Object) x509Certificate.getSubjectX500Principal().getEncoded()));
    }
            ...
            if (instance == null) {
                ...
                if (instance2.getResponseType().equals((ASN1Primitive) OCSPObjectIdentifiers.id_pkix_ocsp_basic)) {
                    try {
                        ...
                        if (!z) {
                            if (!validatedOcspResponse(instance3, this.parameters, bArr, this.parent.getOcspResponderCert(), this.helper)) {
                                return;
                            }
                        }
