...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
    ...
    public void setup() {
        ...
        loadPQCKeys();
        put("X509Store.CERTIFICATE/COLLECTION", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.X509StoreCertCollection");
        put("X509Store.ATTRIBUTECERTIFICATE/COLLECTION", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.X509StoreAttrCertCollection");
        put("X509Store.CRL/COLLECTION", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.X509StoreCRLCollection");
        put("X509Store.CERTIFICATEPAIR/COLLECTION", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.X509StoreCertPairCollection");
        put("X509Store.CERTIFICATE/LDAP", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.X509StoreLDAPCerts");
        put("X509Store.CRL/LDAP", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.X509StoreLDAPCRLs");
        put("X509Store.ATTRIBUTECERTIFICATE/LDAP", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.X509StoreLDAPAttrCerts");
        put("X509Store.CERTIFICATEPAIR/LDAP", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.X509StoreLDAPCertPairs");
        put("X509StreamParser.CERTIFICATE", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.X509CertParser");
        put("X509StreamParser.ATTRIBUTECERTIFICATE", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.X509AttrCertParser");
        put("X509StreamParser.CRL", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.X509CRLParser");
        put("X509StreamParser.CERTIFICATEPAIR", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.X509CertPairParser");
        put("Cipher.BROKENPBEWITHMD5ANDDES", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.BrokenJCEBlockCipher$BrokePBEWithMD5AndDES");
        put("Cipher.BROKENPBEWITHSHA1ANDDES", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.BrokenJCEBlockCipher$BrokePBEWithSHA1AndDES");
        put("Cipher.OLDPBEWITHSHAANDTWOFISH-CBC", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.BrokenJCEBlockCipher$OldPBEWithSHAAndTwofish");
        if (revChkClass != null) {
            put("CertPathValidator.RFC3281", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.PKIXAttrCertPathValidatorSpi");
            put("CertPathBuilder.RFC3281", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.PKIXAttrCertPathBuilderSpi");
            put("CertPathValidator.RFC3280", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.PKIXCertPathValidatorSpi_8");
            put("CertPathBuilder.RFC3280", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.PKIXCertPathBuilderSpi_8");
            put("CertPathValidator.PKIX", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.PKIXCertPathValidatorSpi_8");
            put("CertPathBuilder.PKIX", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.PKIXCertPathBuilderSpi_8");
        } else {
            put("CertPathValidator.RFC3281", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.PKIXAttrCertPathValidatorSpi");
            put("CertPathBuilder.RFC3281", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.PKIXAttrCertPathBuilderSpi");
            put("CertPathValidator.RFC3280", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.PKIXCertPathValidatorSpi");
            put("CertPathBuilder.RFC3280", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.PKIXCertPathBuilderSpi");
            put("CertPathValidator.PKIX", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.PKIXCertPathValidatorSpi");
            put("CertPathBuilder.PKIX", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.PKIXCertPathBuilderSpi");
        }
        put("CertStore.Collection", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.CertStoreCollectionSpi");
        put("CertStore.LDAP", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.X509LDAPCertStoreSpi");
        put("CertStore.Multi", "com.fis.ekyc.nfc.build_in.bouncycastle.jce.provider.MultiCertStoreSpi");
