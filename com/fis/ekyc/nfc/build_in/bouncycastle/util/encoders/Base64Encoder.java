...
public class Base64Encoder implements Encoder {
    ...
    public int decode(byte[] bArr, int i, int i2, OutputStream outputStream) throws IOException {
        ...
        while (nextI < i5) {
            ...
            if ((b | b2 | b3 | b4) >= 0) {
                ...
                int i13 = i7 + 2;
                bArr3[i7 + 1] = (byte) ((b2 << 4) | (b3 >> 2));
                i7 += 3;
                bArr3[i13] = (byte) ((b3 << 6) | b4);
                if (i7 == 54) {
    ...
    public int encode(byte[] bArr, int i, int i2, byte[] bArr2, int i3) throws IOException {
        ...
        while (i5 < i4) {
            ...
            bArr2[i6 + 1] = bArr3[((b << 4) | (b2 >>> 4)) & 63];
            int i8 = i6 + 3;
            bArr2[i6 + 2] = bArr3[((b2 << 2) | ((b3 & 255) >>> 6)) & 63];
            i6 += 4;
            bArr2[i8] = bArr3[b3 & 63];
        }
        int i9 = i2 - (i5 - i);
        if (i9 == 1) {
            byte b4 = bArr[i5] & 255;
            ...
            int i11 = i5 + 1;
            byte b6 = bArr[i5] & 255;
            byte b7 = bArr[i11] & 255;
            byte[] bArr5 = this.encodingTable;
            bArr2[i6] = bArr5[(b6 >>> 2) & 63];
            bArr2[i6 + 1] = bArr5[((b6 << 4) | (b7 >>> 4)) & 63];
            int i12 = i6 + 3;
            bArr2[i6 + 2] = bArr5[(b7 << 2) & 63];
            i6 += 4;
            bArr2[i12] = this.padding;
        }
        return i6 - i3;
    }
