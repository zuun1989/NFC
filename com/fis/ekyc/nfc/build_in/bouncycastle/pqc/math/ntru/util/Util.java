...
import com.fis.ekyc.nfc.build_in.bouncycastle.pqc.math.ntru.euclid.IntEuclidean;
...
public class Util {
    ...
    public static boolean is64BitJVM() {
        ...
        if (!IS_64_BITNESS_KNOWN) {
            ...
            if ("amd64".equals(property) || "x86_64".equals(property) || "ppc64".equals(property) || "64".equals(property2)) {
                z = true;
            } else {
                z = false;
            }
