...
import com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.mceliece.McElieceKobaraImaiCipher;
...
public class McElieceKobaraImaiCipherSpi extends AsymmetricHybridCipher implements PKCSObjectIdentifiers, X509ObjectIdentifiers {
    ...
    public McElieceKobaraImaiCipherSpi(Digest digest2, McElieceKobaraImaiCipher mcElieceKobaraImaiCipher) {
        this.buf = new ByteArrayOutputStream();
        this.digest = digest2;
