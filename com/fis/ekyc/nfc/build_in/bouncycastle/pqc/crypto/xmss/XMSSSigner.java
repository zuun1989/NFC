...
public class XMSSSigner implements StateAwareMessageSigner {
    ...
    public com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.AsymmetricKeyParameter getUpdatedPrivateKey() {
        /*
            r3 = this;
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.xmss.XMSSPrivateKeyParameters r0 = r3.privateKey
            monitor-enter(r0)
            boolean r1 = r3.hasGenerated     // Catch:{ all -> 0x000e }
            if (r1 == 0) goto L_0x0010
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.xmss.XMSSPrivateKeyParameters r1 = r3.privateKey     // Catch:{ all -> 0x000e }
            r2 = 0
            r3.privateKey = r2     // Catch:{ all -> 0x000e }
        ...
        L_0x0010:
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.xmss.XMSSPrivateKeyParameters r2 = r1.getNextKey()     // Catch:{ all -> 0x000e }
            r3.privateKey = r2     // Catch:{ all -> 0x000e }
        L_0x001a:
            monitor-exit(r0)     // Catch:{ all -> 0x000e }
            return r1
        L_0x001c:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.xmss.XMSSSigner.getUpdatedPrivateKey():com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.AsymmetricKeyParameter");
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        if (z) {
            ...
            this.params = xMSSPrivateKeyParameters.getParameters();
        } else {
            this.initSign = false;
            XMSSPublicKeyParameters xMSSPublicKeyParameters = (XMSSPublicKeyParameters) cipherParameters;
            this.publicKey = xMSSPublicKeyParameters;
            this.params = xMSSPublicKeyParameters.getParameters();
        }
