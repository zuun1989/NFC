...
public class WinternitzOTSVerify {
    ...
    public byte[] Verify(byte[] r29, byte[] r30) {
        /*
            ...
            int r8 = r6.mdsize
            byte[] r9 = new byte[r8]
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.Digest r1 = r6.messDigestOTS
            int r2 = r0.length
            r10 = 0
            r1.update(r0, r10, r2)
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.Digest r0 = r6.messDigestOTS
            r0.doFinal(r9, r10)
            int r0 = r6.mdsize
            int r0 = r0 << 3
            int r1 = r6.w
        ...
        L_0x01f2:
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.Digest r4 = r6.messDigestOTS
            r4.update(r1, r3, r2)
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.Digest r4 = r6.messDigestOTS
            r4.doFinal(r1, r3)
            long r25 = r25 + r18
        ...
        L_0x0215:
            ...
            int r3 = r4 >>> 3
            int r10 = r6.mdsize
            if (r3 >= r10) goto L_0x025c
            int r4 = r4 % 8
            r10 = 0
        L_0x0222:
            int r11 = r6.mdsize
            if (r3 >= r11) goto L_0x0235
            byte r11 = r9[r3]
        ...
        L_0x0242:
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.Digest r11 = r6.messDigestOTS
        ...
        L_0x0270:
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.Digest r5 = r6.messDigestOTS
            r11 = 0
            r5.update(r1, r11, r2)
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.Digest r5 = r6.messDigestOTS
            r5.doFinal(r1, r11)
        ...
        L_0x0292:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.util.WinternitzOTSVerify.Verify(byte[], byte[]):byte[]");
    }
