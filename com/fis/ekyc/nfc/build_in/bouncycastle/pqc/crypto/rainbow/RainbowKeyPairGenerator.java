...
public class RainbowKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private void computePublicKey() {
        ...
        short[][][] sArr = (short[][][]) Array.newInstance(cls, iArr2);
        int[] iArr3 = new int[2];
        iArr3[1] = i3;
        iArr3[0] = i2;
        this.pub_singular = (short[][]) Array.newInstance(cls, iArr3);
        ...
        short[][][] sArr16 = (short[][][]) Array.newInstance(cls2, iArr4);
        int[] iArr5 = new int[2];
        iArr5[1] = i28;
        iArr5[0] = i29;
        short[][] sArr17 = (short[][]) Array.newInstance(cls2, iArr5);
        int i30 = i29;
