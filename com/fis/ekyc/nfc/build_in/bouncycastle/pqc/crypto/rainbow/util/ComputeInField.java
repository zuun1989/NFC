package com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.rainbow.util;
...
public class ComputeInField {
    ...
    private void computeZerosUnder(boolean r10) throws java.lang.RuntimeException {
        ...
        L_0x0018:
            ...
            r3 = r3[r0]
            short r3 = r3[r0]
            short r3 = com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.rainbow.util.GF2Field.invElem(r3)
        ...
        L_0x002c:
            ...
            r6 = r6[r0]
            short r6 = r6[r5]
            short r6 = com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.rainbow.util.GF2Field.multElem(r6, r3)
            short r6 = com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.rainbow.util.GF2Field.multElem(r4, r6)
            short[][] r7 = r9.A
            r7 = r7[r2]
            short r8 = r7[r5]
            short r6 = com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.rainbow.util.GF2Field.addElem(r8, r6)
            r7[r5] = r6
            int r5 = r5 + 1
            goto L_0x002c
        L_0x004b:
        ...
        L_0x0058:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.rainbow.util.ComputeInField.computeZerosUnder(boolean):void");
    }
