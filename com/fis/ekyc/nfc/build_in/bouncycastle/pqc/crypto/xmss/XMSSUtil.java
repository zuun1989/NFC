...
public class XMSSUtil {
    ...
    public static class CheckingStream extends ObjectInputStream {
        ...
        static {
            ...
            hashSet.add("com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.xmss.BDS");
            hashSet.add("java.util.ArrayList");
            hashSet.add("com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.xmss.XMSSNode");
            hashSet.add("[B");
            hashSet.add("java.util.LinkedList");
            hashSet.add("java.util.Stack");
            hashSet.add("java.util.Vector");
            hashSet.add("[Ljava.lang.Object;");
            hashSet.add("com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.xmss.BDSTreeHash");
        }
    ...
    public static boolean isNewAuthenticationPathNeeded(long j, int i, int i2) {
        if (j != 0 && (j + 1) % ((long) Math.pow((double) (1 << i), (double) i2)) == 0) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isNewBDSInitNeeded(long j, int i, int i2) {
        if (j != 0 && j % ((long) Math.pow((double) (1 << i), (double) (i2 + 1))) == 0) {
            return true;
        }
        return false;
    }
