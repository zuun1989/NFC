    ...
    public XMSSReducedSignature(Builder builder) {
        ...
        if (access$000 != null) {
            ...
            if (access$100 != null) {
                if (access$100.length == (len * treeDigestSize) + (height * treeDigestSize)) {
                    ...
                    for (int i3 = 0; i3 < height; i3++) {
                        arrayList.add(new XMSSNode(i3, XMSSUtil.extractBytesAtOffset(access$100, i, treeDigestSize)));
                        i += treeDigestSize;
                    }
            ...
            if (access$200 != null) {
                ...
                iArr[0] = len;
                this.wotsPlusSignature = new WOTSPlusSignature(params2, (byte[][]) Array.newInstance(Byte.TYPE, iArr));
            }
