...
public class LMSPrivateKeyParameters extends LMSKeyParameters implements LMSContextBasedSigner {
    ...
    public static class CacheKey {
        ...
        public boolean equals(Object obj) {
            if (!(obj instanceof CacheKey) || ((CacheKey) obj).index != this.index) {
                return false;
            }
            return true;
        }
    ...
    public int hashCode() {
        ...
        if (lMOtsParameters != null) {
            i2 = lMOtsParameters.hashCode();
        } else {
            i2 = 0;
        }
        int hashCode2 = (((((i4 + i2) * 31) + this.maxQ) * 31) + Arrays.hashCode(this.masterSecret)) * 31;
        LMSPublicKeyParameters lMSPublicKeyParameters = this.publicKey;
        if (lMSPublicKeyParameters != null) {
            i3 = lMSPublicKeyParameters.hashCode();
        }
        return hashCode2 + i3;
    }
    ...
    public static com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.lms.LMSPrivateKeyParameters getInstance(java.lang.Object r8) throws java.io.IOException {
        /*
            boolean r0 = r8 instanceof com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.lms.LMSPrivateKeyParameters
        ...
        L_0x0007:
            ...
            int r0 = r8.readInt()
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.lms.LMSigParameters r2 = com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.lms.LMSigParameters.getParametersForType(r0)
            int r0 = r8.readInt()
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.lms.LMOtsParameters r3 = com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.lms.LMOtsParameters.getParametersForType(r0)
            r0 = 16
            byte[] r5 = new byte[r0]
            r8.readFully(r5)
            int r4 = r8.readInt()
            ...
            byte[] r7 = new byte[r0]
            r8.readFully(r7)
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.lms.LMSPrivateKeyParameters r8 = new com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.lms.LMSPrivateKeyParameters
            r1 = r8
        ...
        L_0x0075:
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.lms.LMSPrivateKeyParameters r8 = getInstance(r1)     // Catch:{ all -> 0x008e }
            r1.close()
            return r8
        L_0x008e:
            r8 = move-exception
        ...
        L_0x0098:
            ...
            byte[] r8 = com.fis.ekyc.nfc.build_in.bouncycastle.util.io.Streams.readAll(r8)
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.lms.LMSPrivateKeyParameters r8 = getInstance(r8)
            return r8
        L_0x00a7:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.lms.LMSPrivateKeyParameters.getInstance(java.lang.Object):com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.lms.LMSPrivateKeyParameters");
    }
