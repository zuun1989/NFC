...
public class GMSSPrivateKeyParameters extends GMSSKeyParameters {
    ...
    public GMSSPrivateKeyParameters(int[] r17, byte[][] r18, byte[][] r19, byte[][][] r20, byte[][][] r21, byte[][][] r22, com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.Treehash[][] r23, com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.Treehash[][] r24, java.util.Vector[] r25, java.util.Vector[] r26, java.util.Vector[][] r27, java.util.Vector[][] r28, com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf[] r29, com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf[] r30, com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf[] r31, int[] r32, byte[][] r33, com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSRootCalc[] r34, byte[][] r35, com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSRootSig[] r36, com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSParameters r37, com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSDigestProvider r38) {
        /*
            r16 = this;
            r0 = r16
            r1 = r17
            ...
            r15 = 0
            r0.used = r15
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.Digest r14 = r38.get()
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSParameters r13 = r0.gmssPS
        ...
        L_0x005f:
            ...
            r1 = r19
            r0.nextNextSeeds = r1
            byte[][][] r1 = com.fis.ekyc.nfc.build_in.bouncycastle.util.Arrays.clone((byte[][][]) r20)
        ...
        L_0x00e6:
            ...
            r3 = 1
            int r2 = r2 - r3
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSRootCalc[] r2 = new com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSRootCalc[r2]
            r0.nextNextRoot = r2
            r2 = r15
        L_0x0105:
            int r4 = r0.numLayer
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSRootCalc[] r3 = r0.nextNextRoot
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSRootCalc r4 = new com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSRootCalc
            int[] r5 = r0.heightOfTrees
            int r11 = r2 + 1
            r5 = r5[r11]
            int[] r12 = r0.K
            r12 = r12[r11]
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSDigestProvider r13 = r0.digestProvider
            r4.<init>(r5, r12, r13)
            r3[r2] = r4
            r2 = r11
            r3 = 1
        ...
        L_0x0143:
            r5 = 1
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.util.GMSSRandom r2 = new com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.util.GMSSRandom
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.Digest r3 = r0.messDigestTrees
            r2.<init>(r3)
            r0.gmssRandom = r2
            int r2 = r0.numLayer
            ...
            r3 = 2
            int r2 = r2 - r3
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf[] r2 = new com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf[r2]
            r0.nextNextLeaf = r2
            r2 = r15
        L_0x015a:
            int r4 = r0.numLayer
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf[] r4 = r0.nextNextLeaf
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf r5 = new com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.Digest r6 = r38.get()
            int[] r11 = r0.otsIndex
            int r12 = r2 + 1
            r11 = r11[r12]
            int[] r13 = r0.numLeafs
        ...
        L_0x017e:
            ...
            goto L_0x0185
        L_0x0181:
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf[] r2 = new com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf[r15]
            r0.nextNextLeaf = r2
        L_0x0185:
        ...
        L_0x0190:
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf[] r3 = r0.upperLeaf
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf r4 = new com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.Digest r5 = r38.get()
            int[] r6 = r0.otsIndex
            r6 = r6[r2]
            int[] r7 = r0.numLeafs
            int r11 = r2 + 1
        ...
        L_0x01c0:
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf[] r3 = r0.upperTreehashLeaf
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf r4 = new com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.Digest r5 = r38.get()
            int[] r6 = r0.otsIndex
            r6 = r6[r2]
            ...
            int r8 = r2 + 1
            r7 = r7[r8]
            r4.<init>((com.fis.ekyc.nfc.build_in.bouncycastle.crypto.Digest) r5, (int) r6, (int) r7)
            r3[r2] = r4
            r2 = r8
            r3 = 1
            goto L_0x01c0
        ...
        L_0x01fc:
            ...
            r4 = 1
            int r2 = r2 - r4
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSRootSig[] r2 = new com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSRootSig[r2]
            r0.nextRootSig = r2
            r2 = r15
        L_0x020f:
            int r5 = r0.numLayer
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.util.GMSSRandom r5 = r0.gmssRandom
            r5.nextSeed(r3)
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.util.GMSSRandom r5 = r0.gmssRandom
            byte[] r5 = r5.nextSeed(r3)
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSRootSig[] r6 = r0.nextRootSig
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSRootSig r7 = new com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSRootSig
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.Digest r8 = r38.get()
            int[] r9 = r0.otsIndex
            r9 = r9[r2]
            int[] r11 = r0.heightOfTrees
            int r12 = r2 + 1
            r11 = r11[r12]
            r7.<init>((com.fis.ekyc.nfc.build_in.bouncycastle.crypto.Digest) r8, (int) r9, (int) r11)
            r6[r2] = r7
            com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSRootSig[] r6 = r0.nextRootSig
            r6 = r6[r2]
            r2 = r10[r2]
        ...
        L_0x024a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSPrivateKeyParameters.<init>(int[], byte[][], byte[][], byte[][][], byte[][][], byte[][][], com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.Treehash[][], com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.Treehash[][], java.util.Vector[], java.util.Vector[], java.util.Vector[][], java.util.Vector[][], com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf[], com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf[], com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSLeaf[], int[], byte[][], com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSRootCalc[], byte[][], com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSRootSig[], com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSParameters, com.fis.ekyc.nfc.build_in.bouncycastle.pqc.crypto.gmss.GMSSDigestProvider):void");
    }
