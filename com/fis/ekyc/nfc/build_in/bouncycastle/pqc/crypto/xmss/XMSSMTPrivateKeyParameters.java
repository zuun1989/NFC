        ...
        if (access$000 != null) {
            ...
            if (access$100 == null) {
                ...
                if (XMSSUtil.isIndexValid(height, this.index)) {
                    this.secretKeySeed = XMSSUtil.extractBytesAtOffset(access$100, i, treeDigestSize);
                    int i2 = i + treeDigestSize;
                    this.secretKeyPRF = XMSSUtil.extractBytesAtOffset(access$100, i2, treeDigestSize);
                    int i3 = i2 + treeDigestSize;
                    this.publicSeed = XMSSUtil.extractBytesAtOffset(access$100, i3, treeDigestSize);
                    int i4 = i3 + treeDigestSize;
                    this.root = XMSSUtil.extractBytesAtOffset(access$100, i4, treeDigestSize);
                    int i5 = i4 + treeDigestSize;
                    try {
                        this.bdsState = ((BDSStateMap) XMSSUtil.deserialize(XMSSUtil.extractBytesAtOffset(access$100, i5, access$100.length - i5), BDSStateMap.class)).withWOTSDigest(builder.xmss.getTreeDigestOID());
                    } catch (IOException e) {
