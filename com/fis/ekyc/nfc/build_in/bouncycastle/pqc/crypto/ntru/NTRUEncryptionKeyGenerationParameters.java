...
public class NTRUEncryptionKeyGenerationParameters extends KeyGenerationParameters implements Cloneable {
    ...
    public static final NTRUEncryptionKeyGenerationParameters EES1171EP1 = new NTRUEncryptionKeyGenerationParameters(1171, 2048, LDSFile.EF_DG10_TAG, LDSFile.EF_DG10_TAG, 256, 13, 20, 15, true, new byte[]{0, 6, 4}, true, false, new SHA512Digest());
    ...
    public NTRUEncryptionKeyGenerationParameters(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, boolean z, byte[] bArr, boolean z2, boolean z3, Digest digest) {
        this(i, i2, i3, i4, i5, i6, i7, i8, z, bArr, z2, z3, digest, (SecureRandom) null);
    }
    ...
    public NTRUEncryptionKeyGenerationParameters(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, boolean z, byte[] bArr, boolean z2, boolean z3, Digest digest) {
        this(i, i2, i3, i4, i5, i6, i7, i8, i9, i10, z, bArr, z2, z3, digest, (SecureRandom) null);
    }
