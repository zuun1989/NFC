...
public class SPHINCS256Signer implements MessageSigner {
    ...
    public static void compute_authpath_wots(HashFunctions hashFunctions2, byte[] bArr, byte[] bArr2, int i, Tree.leafaddr leafaddr, byte[] bArr3, byte[] bArr4, int i2) {
        ...
        leafaddr3.subleaf = 0;
        while (true) {
            long j = leafaddr3.subleaf;
            if (j >= 32) {
                break;
            }
            Seed.get_seed(hashFunctions2, bArr6, (int) (j * 32), bArr3, leafaddr3);
            leafaddr3.subleaf++;
        }
        ...
        leafaddr3.subleaf = 0;
        while (true) {
            long j2 = leafaddr3.subleaf;
            if (j2 >= 32) {
                break;
            }
            wots.wots_pkgen(hashFunctions2, bArr7, (int) (j2 * 2144), bArr6, (int) (j2 * 32), bArr4, 0);
            leafaddr3.subleaf++;
            HashFunctions hashFunctions4 = hashFunctions2;
        }
        leafaddr3.subleaf = 0;
        while (true) {
            long j3 = leafaddr3.subleaf;
            if (j3 >= 32) {
                break;
            }
            Tree.l_tree(hashFunctions2, bArr5, (int) ((j3 * 32) + 1024), bArr7, (int) (j3 * 2144), bArr4, 0);
            leafaddr3.subleaf++;
        }
        int i3 = 0;
        for (int i4 = 32; i4 > 0; i4 >>>= 1) {
            for (int i5 = 0; i5 < i4; i5 += 2) {
                hashFunctions2.hash_2n_n_mask(bArr5, ((i4 >>> 1) * 32) + ((i5 >>> 1) * 32), bArr5, (i4 * 32) + (i5 * 32), bArr4, (i3 + 7) * 64);
            }
            i3++;
        }
    ...
    public static void validate_authpath(HashFunctions hashFunctions2, byte[] bArr, byte[] bArr2, int i, byte[] bArr3, int i2, byte[] bArr4, int i3) {
        ...
        while (i9 < i3 - 1) {
            int i11 = i10 >>> 1;
            if ((i11 & 1) != 0) {
                hashFunctions2.hash_2n_n_mask(bArr5, 32, bArr5, 0, bArr4, (i9 + 7) * 64);
                for (int i12 = 0; i12 < 32; i12++) {
                    bArr5[i12] = bArr3[i8 + i12];
                }
            } else {
                hashFunctions2.hash_2n_n_mask(bArr5, 0, bArr5, 0, bArr4, (i9 + 7) * 64);
        ...
        hashFunctions2.hash_2n_n_mask(bArr, 0, bArr5, 0, bArr4, (i3 + 6) * 64);
    }
    ...
    public byte[] crypto_sign(HashFunctions hashFunctions2, byte[] bArr, byte[] bArr2) {
        ...
        for (int i4 = 0; i4 < 8; i4++) {
            bArr4[32 + i4] = (byte) ((int) ((j2 >>> (i4 * 8)) & 255));
        }
        byte[] bArr19 = bArr15;
        ...
        for (int i6 = 12; i5 < i6; i6 = 12) {
            leafaddr2.level = i5;
            Seed.get_seed(hashFunctions3, bArr19, 0, bArr20, leafaddr2);
            byte[] bArr21 = bArr4;
            int i7 = horst_sign;
            int i8 = i5;
            byte[] bArr22 = bArr18;
            wots.wots_sign(hashFunctions2, bArr21, horst_sign, bArr16, bArr19, bArr22);
            compute_authpath_wots(hashFunctions2, bArr16, bArr21, i7 + 2144, leafaddr2, bArr20, bArr22, 5);
            horst_sign = i7 + 2304;
            long j3 = leafaddr2.subtree;
            leafaddr2.subleaf = (long) ((int) (j3 & 31));
            leafaddr2.subtree = j3 >>> 5;
            i5 = i8 + 1;
            bArr18 = bArr18;
        }
        zerobytes(bArr20, 0, 1088);
        return bArr4;
    }
    ...
    public boolean verify(HashFunctions hashFunctions2, byte[] bArr, byte[] bArr2, byte[] bArr3) {
        ...
        if (bArr5.length == 41000) {
            ...
            while (i4 < 12) {
                ...
                Tree.l_tree(hashFunctions2, bArr7, 0, bArr6, 0, bArr10, 0);
                byte[] bArr13 = bArr10;
                byte[] bArr14 = bArr9;
                validate_authpath(hashFunctions2, bArr8, bArr7, (int) (31 & j), bArr14, i6 + 2144, bArr13, 5);
                j >>= 5;
                i5 = i6 + 2304;
                i4++;
                bArr10 = bArr13;
