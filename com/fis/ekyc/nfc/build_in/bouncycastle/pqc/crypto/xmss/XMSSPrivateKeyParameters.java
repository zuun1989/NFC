    ...
    private XMSSPrivateKeyParameters(Builder builder) {
        ...
        if (access$000 != null) {
            ...
            if (access$100 != null) {
                ...
                } else if (builder.index >= (1 << access$000.getHeight()) - 2 || access$400 == null || access$200 == null) {
                    this.bdsState = new BDS(access$000, (1 << access$000.getHeight()) - 1, builder.index);
                } else {
                    this.bdsState = new BDS(access$000, access$400, access$200, (OTSHashAddress) new OTSHashAddress.Builder().build(), builder.index);
                }
