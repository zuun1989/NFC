...
public class DSTU4145BinaryField extends ASN1Object {
    ...
    private DSTU4145BinaryField(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.getObjectAt(1) instanceof ASN1Integer) {
            ...
            this.k = ASN1Integer.getInstance(instance.getObjectAt(0)).intPositiveValueExact();
            this.j = ASN1Integer.getInstance(instance.getObjectAt(1)).intPositiveValueExact();
            this.l = ASN1Integer.getInstance(instance.getObjectAt(2)).intPositiveValueExact();
        } else {
