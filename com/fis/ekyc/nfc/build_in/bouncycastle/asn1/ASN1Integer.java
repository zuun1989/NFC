...
public class ASN1Integer extends ASN1Primitive {
    ...
    public static boolean isMalformed(byte[] bArr) {
        ...
        if (bArr[0] != (bArr[1] >> 7) || Properties.isOverrideSet("com.fis.ekyc.nfc.build_in.bouncycastle.asn1.allow_unsafe_integer")) {
            return false;
        }
        return true;
    }
    ...
    public boolean hasValue(BigInteger bigInteger) {
        if (bigInteger == null || intValue(this.bytes, this.start, -1) != bigInteger.intValue() || !getValue().equals(bigInteger)) {
            return false;
        }
        return true;
    }
    ...
    public int intPositiveValueExact() {
        ...
        int i = this.start;
        int i2 = length - i;
        if (i2 <= 4 && (i2 != 4 || (bArr[i] & ISOFileInfo.DATA_BYTES1) == 0)) {
