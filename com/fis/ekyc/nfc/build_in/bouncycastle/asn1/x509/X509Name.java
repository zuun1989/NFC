    ...
    public boolean equals(Object obj) {
        ...
        try {
            ...
            while (i3 != i2) {
                ...
                int i4 = 0;
                while (i4 < size) {
                    if (!zArr[i4] && aSN1ObjectIdentifier.equals((ASN1Primitive) (ASN1ObjectIdentifier) instance.ordering.elementAt(i4)) && equivalentStrings(str, (String) instance.values.elementAt(i4))) {
                        zArr[i4] = true;
                        i3 += i;
                    } else {
                        i4++;
