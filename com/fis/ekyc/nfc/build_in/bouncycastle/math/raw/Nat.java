...
public abstract class Nat {
    ...
    public static void square(int i, int[] iArr, int[] iArr2) {
        ...
        int i8 = 2;
        for (i2 = 1; i2 < i; i2++) {
            long squareWordAddTo = j3 + (((long) squareWordAddTo(iArr, i2, iArr2)) & 4294967295L) + (((long) iArr2[i8]) & 4294967295L);
            int i9 = i8 + 1;
            iArr2[i8] = (int) squareWordAddTo;
            long j4 = (squareWordAddTo >>> 32) + (((long) iArr2[i9]) & 4294967295L);
            i8 += 2;
            iArr2[i9] = (int) j4;
            j3 = j4 >>> 32;
        }
    ...
    public static int csub(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4, int[] iArr3, int i5) {
        ...
        for (int i7 = 0; i7 < i6; i7++) {
            long j3 = j2 + ((((long) iArr[i3 + i7]) & 4294967295L) - (((long) iArr2[i4 + i7]) & j));
            iArr3[i5 + i7] = (int) j3;
            j2 = j3 >> 32;
        }
        return (int) j2;
    ...
    public static void square(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        long j3 = 0;
        for (i4 = 1; i4 < i; i4++) {
            long squareWordAddTo = j3 + (((long) squareWordAddTo(iArr, i2, i4, iArr2, i3)) & 4294967295L) + (((long) iArr2[i9]) & 4294967295L);
            int i10 = i9 + 1;
