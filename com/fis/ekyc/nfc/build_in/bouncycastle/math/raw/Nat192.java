...
public abstract class Nat192 {
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 6; i < i2; i2 = 6) {
            ...
            long j15 = (j14 * j) + (((long) iArr3[i]) & 4294967295L);
            iArr3[i] = (int) j15;
            int i3 = i + 1;
            int i4 = i3;
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i4 <= 0) {
                ...
                int i17 = (int) j43;
                iArr2[10] = i16 | (i17 << 1);
                iArr2[11] = (i17 >>> 31) | ((iArr2[11] + ((int) (j43 >>> 32))) << 1);
                return;
            }
            i3 = i4;
        }
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i6 <= 0) {
                ...
                int i23 = i2 + 10;
                int i24 = i22;
                long j36 = (j28 & 4294967295L) + (j * j33);
                int i25 = (int) j36;
                iArr2[i14] = (i25 << 1) | i21;
                long j37 = (j29 & 4294967295L) + (j36 >>> 32) + (j5 * j33);
                long j38 = j34 + (j37 >>> 32) + (j33 * j14);
                long j39 = (j31 & 4294967295L) + (j38 >>> 32) + (j33 * j24);
                long j40 = (j35 & 4294967295L) + (j39 >>> 32) + (j33 * j32);
                long j41 = (((long) iArr2[i23]) & 4294967295L) + (j35 >>> 32) + (j40 >>> 32);
                int i26 = (int) j37;
                iArr2[i15] = (i25 >>> 31) | (i26 << 1);
                int i27 = (int) j38;
                ...
                int i34 = i33 >>> 31;
                int i35 = i2 + 11;
                iArr2[i35] = i34 | ((iArr2[i35] + ((int) (j41 >>> 32))) << 1);
                return;
            }
            i5 = i6;
        }
