...
public abstract class Nat384 {
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        if (Nat192.diff(iArr, 6, iArr, 0, create, 0) != Nat192.diff(iArr2, 6, iArr2, 0, create2, 0)) {
            z = true;
        } else {
            z = false;
        }
        ...
        if (z) {
            i = Nat.addTo(12, createExt, 0, iArr3, 6);
        } else {
            i = Nat.subFrom(12, createExt, 0, iArr3, 6);
        }
        Nat.addWordAt(24, addTo + i, iArr3, 18);
    }
