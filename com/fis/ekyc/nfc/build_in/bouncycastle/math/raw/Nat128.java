    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i4 <= 0) {
                ...
                int i12 = (int) j20;
                iArr2[6] = i11 | (i12 << 1);
                iArr2[7] = ((iArr2[7] + ((int) (j20 >>> 32))) << 1) | (i12 >>> 31);
                return;
            }
            i3 = i4;
        }
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i6 <= 0) {
                ...
                long j17 = (j12 & 4294967295L) + (j16 >>> 32) + (j5 * j13);
                long j18 = (4294967295L & j15) + (j17 >>> 32) + (j13 * j14);
                long j19 = (((long) iArr2[i15]) & 4294967295L) + (j15 >>> 32) + (j18 >>> 32);
                int i17 = (int) j17;
                iArr2[i11] = (i16 >>> 31) | (i17 << 1);
                int i18 = i17 >>> 31;
                int i19 = (int) j18;
                iArr2[i14] = i18 | (i19 << 1);
                int i20 = i19 >>> 31;
                ...
                int i22 = i21 >>> 31;
                int i23 = i2 + 7;
                iArr2[i23] = i22 | ((iArr2[i23] + ((int) (j19 >>> 32))) << 1);
                return;
            }
            i5 = i6;
        }
