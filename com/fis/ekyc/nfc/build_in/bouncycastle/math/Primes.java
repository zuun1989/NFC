...
public abstract class Primes {
    ...
    public static class MROutput {
        ...
        public boolean isNotPrimePower() {
            if (!this.provablyComposite || this.factor != null) {
                return false;
            }
            return true;
        }
            ...
            if (!(intValue2 % 29 == 0 || intValue2 % 31 == 0 || intValue2 % 37 == 0 || intValue2 % 41 == 0 || intValue2 % 43 == 0)) {
                ...
                if (!(intValue3 % 47 == 0 || intValue3 % 53 == 0 || intValue3 % 59 == 0 || intValue3 % 61 == 0 || intValue3 % 67 == 0)) {
                    ...
                    if (!(intValue4 % 71 == 0 || intValue4 % 73 == 0 || intValue4 % 79 == 0 || intValue4 % 83 == 0)) {
                        ...
                        if (!(intValue5 % 89 == 0 || intValue5 % 97 == 0 || intValue5 % LDSFile.EF_DG5_TAG == 0 || intValue5 % LDSFile.EF_DG7_TAG == 0)) {
                            int intValue6 = bigInteger.mod(BigInteger.valueOf((long) 167375713)).intValue();
                            if (!(intValue6 % LDSFile.EF_DG11_TAG == 0 || intValue6 % LDSFile.EF_DG13_TAG == 0 || intValue6 % 113 == 0 || intValue6 % CertificateBody.profileType == 0)) {
                                int intValue7 = bigInteger.mod(BigInteger.valueOf((long) 371700317)).intValue();
                                if (!(intValue7 % ISO781611.CREATION_DATE_AND_TIME_TAG == 0 || intValue7 % 137 == 0 || intValue7 % 139 == 0 || intValue7 % 149 == 0)) {
                                    int intValue8 = bigInteger.mod(BigInteger.valueOf((long) 645328247)).intValue();
                                    if (!(intValue8 % ISO7816.TAG_SM_EXPECTED_LENGTH == 0 || intValue8 % 157 == 0 || intValue8 % 163 == 0 || intValue8 % 167 == 0)) {
