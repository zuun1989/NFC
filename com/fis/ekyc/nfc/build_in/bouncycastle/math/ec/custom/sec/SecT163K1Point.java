...
public class SecT163K1Point extends ECPoint.AbstractF2m {
            ...
            if (!add2.isZero()) {
                if (rawXCoord.isZero()) {
                    ...
                    if (eCFieldElement5.isZero()) {
                        return new SecT163K1Point(curve, eCFieldElement5, curve.getB());
                    }
                ...
                return new SecT163K1Point(curve, eCFieldElement5, eCFieldElement4, new ECFieldElement[]{eCFieldElement6});
            } else if (add.isZero()) {
                return twice();
            } else {
    ...
    public ECPoint twice() {
        ...
        return new SecT163K1Point(curve, square, square2.add(add).add(eCFieldElement5).multiply(square2).add(square), new ECFieldElement[]{eCFieldElement2});
    }
