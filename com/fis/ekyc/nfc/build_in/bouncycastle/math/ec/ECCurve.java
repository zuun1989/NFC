...
public abstract class ECCurve {
    ...
    public static abstract class AbstractF2m extends ECCurve {
        ...
        public boolean isKoblitz() {
            if (this.order == null || this.cofactor == null || !this.b.isOne() || (!this.a.isZero() && !this.a.isOne())) {
                return false;
            }
            return true;
        }
        ...
        public boolean isValidFieldElement(BigInteger bigInteger) {
            if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.bitLength() > getFieldSize()) {
                return false;
            }
            return true;
        }
    ...
    public static abstract class AbstractFp extends ECCurve {
        ...
        public boolean isValidFieldElement(BigInteger bigInteger) {
            if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(getField().getCharacteristic()) >= 0) {
                return false;
            }
            return true;
        }
