...
public class SecT131R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        return new SecT131R2Point(curve, square, eCFieldElement4.squarePlusProduct(add, eCFieldElement).add(square).add(eCFieldElement3), new ECFieldElement[]{eCFieldElement3});
    }
