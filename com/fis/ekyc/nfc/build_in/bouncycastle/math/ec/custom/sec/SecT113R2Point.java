...
public class SecT113R2Point extends ECPoint.AbstractF2m {
            ...
            if (!add2.isZero()) {
                if (rawXCoord.isZero()) {
                    ...
                    if (eCFieldElement5.isZero()) {
                        return new SecT113R2Point(curve, eCFieldElement5, curve.getB().sqrt());
                    }
                ...
                return new SecT113R2Point(curve, eCFieldElement5, eCFieldElement4, new ECFieldElement[]{eCFieldElement6});
            } else if (add.isZero()) {
                return twice();
            } else {
    ...
    public ECPoint twice() {
        ...
        return new SecT113R2Point(curve, square, eCFieldElement4.squarePlusProduct(add, eCFieldElement).add(square).add(eCFieldElement3), new ECFieldElement[]{eCFieldElement3});
    }
