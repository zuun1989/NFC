...
public class SecT283K1Point extends ECPoint.AbstractF2m {
            ...
            if (!add2.isZero()) {
                if (rawXCoord.isZero()) {
                    ...
                    if (eCFieldElement5.isZero()) {
                        return new SecT283K1Point(curve, eCFieldElement5, curve.getB());
                    }
                ...
                return new SecT283K1Point(curve, eCFieldElement5, eCFieldElement4, new ECFieldElement[]{eCFieldElement6});
            } else if (add.isZero()) {
                return twice();
            } else {
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElement2.isZero()) {
            return new SecT283K1Point(curve, eCFieldElement2, curve.getB());
        }
        ...
        return new SecT283K1Point(curve, square, square2.add(eCFieldElement2).add(eCFieldElement).multiply(square2).add(eCFieldElement6).add(square).add(eCFieldElement3), new ECFieldElement[]{eCFieldElement3});
    }
