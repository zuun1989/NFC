...
class LongArray implements Cloneable {
    ...
    private static int bitLength(long r3) {
        ...
        L_0x002e:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fis.ekyc.nfc.build_in.bouncycastle.math.ec.LongArray.bitLength(long):int");
    }
    ...
    private static int reduceInPlace(long[] jArr, int i, int i2, int i3, int[] iArr) {
        ...
        int min2 = (i10 + Math.min(min - max, i7 - i4)) >> 6;
        if (min2 > 1) {
            int i13 = i11 - min2;
            reduceVectorWise(jArr, i, i11, i13, i3, iArr);
            while (i11 > i13) {
                i11--;
                jArr2[i5 + i11] = 0;
            }
        ...
        if (min > max) {
            reduceWordWise(jArr, i, i11, max, i3, iArr);
        } else {
            max = min;
        }
        if (max > i7) {
            reduceBitWise(jArr, i, max, i7, iArr2);
        }
        return i8;
    }
    ...
    public LongArray modMultiply(LongArray longArray, int i, int[] iArr) {
        ...
        if (i8 == 1) {
            ...
            multiplyWord(j, longArray3.m_ints, i9, jArr2, 0);
            return reduceResult(jArr2, 0, i10, i7, iArr2);
        }
        int i11 = (i2 + 70) >>> 6;
        ...
        iArr3[1] = i11;
        System.arraycopy(longArray3.m_ints, 0, jArr3, i11, i9);
        int i13 = 2;
        int i14 = i11;
        for (int i15 = 16; i13 < i15; i15 = 16) {
            ...
            if ((i13 & 1) == 0) {
                jArr = jArr3;
                i6 = i12;
                shiftUp(jArr3, i14 >>> 1, jArr3, i14, i11, 1);
            } else {
                jArr = jArr3;
                i6 = i12;
                add(jArr, i11, jArr3, i14 - i11, jArr, i14, i11);
            }
            i13++;
            i12 = i6;
            jArr3 = jArr;
        ...
        while (i18 < i8) {
            ...
            while (true) {
                i4 = i17;
                i5 = i18;
                addBoth(jArr7, i19, jArr4, iArr3[((int) j2) & 15], jArr5, iArr3[((int) (j2 >>> 4)) & 15], i11);
                j2 >>>= 8;
                if (j2 == 0) {
                    break;
                }
        ...
        while (true) {
            i17 -= i10;
            if (i17 == 0) {
                return reduceResult(jArr7, 0, i10, i7, iArr2);
            }
            addShiftedUp(jArr7, i17 - i10, jArr7, i17, i10, 8);
        }
    }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        if (i6 == 1) {
            ...
            multiplyWord(j, longArray2.m_ints, i7, jArr, 0);
            return reduceResult(jArr, 0, i8, i5, iArr2);
        }
        int i9 = (i2 + 78) >>> 6;
        int i10 = i9 * 8;
        int[] iArr3 = new int[16];
        ...
        int i13 = 0;
        long[] jArr3 = new long[(i11 + i8 + 1)];
        int[] iArr4 = iArr3;
        int i14 = i10;
        interleave(jArr2, 0, jArr3, 0, i6, 4);
        System.arraycopy(longArray2.m_ints, 0, jArr3, i6, i7);
        int i15 = i6;
        int i16 = 1;
        while (i16 < 8) {
            int i17 = i15 + i9;
            shiftUp(jArr3, i6, jArr3, i17, i9, i16);
            i16++;
            i15 = i17;
        }
        int i18 = 15;
        ...
        while (true) {
            ...
            while (true) {
                int i21 = i6;
                long j2 = jArr3[i20] >>> i19;
                int i22 = i13;
                while (true) {
                    int i23 = ((int) j2) & i18;
                    if (i23 != 0) {
                        add(jArr3, iArr4[i23] + i20, jArr3, i21, i9);
                    }
                    i22++;
                    if (i22 == 8) {
                        break;
        ...
        while (true) {
            int i26 = i25 - 1;
            if (i26 <= 1) {
                return reduceResult(jArr3, iArr4[1], i8, i5, iArr2);
            }
            if ((((long) i26) & 1) == 0) {
                addShiftedUp(jArr3, iArr4[i26 >>> 1], jArr3, iArr4[i26], i8, 16);
            } else {
                distribute(jArr3, iArr4[i26], iArr4[i25 - 2], iArr4[1], i8);
            }
            i25 = i26;
        }
    }
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i, int[] iArr) {
        ...
        while (true) {
            ...
            int i16 = 1;
            while (i16 < i6) {
                int i17 = (int) (jArr6[i16] >>> i14);
                addBoth(jArr7, i16 - 1, jArr4, iArr3[i17 & 15], jArr5, iArr3[(i17 >>> 4) & 15], i9);
                i16 += 2;
                i15 = i15;
            }
            shiftUp(jArr7, 0, i8, i15);
            i14 -= 8;
        }
        for (int i18 = 56; i18 >= 0; i18 -= 8) {
            for (int i19 = 0; i19 < i6; i19 += 2) {
                int i20 = (int) (jArr6[i19] >>> i18);
                addBoth(jArr7, i19, jArr4, iArr3[i20 & 15], jArr5, iArr3[(i20 >>> 4) & 15], i9);
            }
            if (i18 > 0) {
    ...
    private static long interleave2_n(long j, int i) {
        while (i > 1) {
            i -= 2;
            j = (interleave4_16to64(((int) (j >>> 48)) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) << 3) | (interleave4_16to64(((int) (j >>> 16)) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) << 1) | interleave4_16to64(((int) j) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) | (interleave4_16to64(((int) (j >>> 32)) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) << 2);
        }
        if (i <= 0) {
            return j;
        }
