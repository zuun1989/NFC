...
public final class Kangaroo {
    ...
    public static abstract class KangarooBase implements ExtendedDigest, Xof {
        ...
        private static final byte[] INTERMEDIATE = {IdCardService.SFI_DG11};
        ...
        public KangarooBase(int i, int i2, int i3) {
        ...
        private void buildPersonal(byte[] bArr) {
            ...
            byte[] lengthEncode = lengthEncode((long) i);
            if (bArr == null) {
                bArr2 = new byte[(lengthEncode.length + i)];
            } else {
                bArr2 = Arrays.copyOf(bArr, lengthEncode.length + i);
            }
            this.thePersonal = bArr2;
            System.arraycopy(lengthEncode, 0, bArr2, i, lengthEncode.length);
        }
        ...
        private void processData(byte[] bArr, int i, int i2) {
            KangarooSponge kangarooSponge;
            if (!this.squeezing) {
                if (this.theCurrNode == 0) {
                    kangarooSponge = this.theTree;
                } else {
                    kangarooSponge = this.theLeaf;
                }
    ...
    public static class KangarooSponge {
        ...
        public KangarooSponge(int i, int i2) {
            int i3 = (1600 - (i << 1)) >> 3;
        ...
        public void padAndSwitchToSqueezingPhase() {
            ...
            while (true) {
                ...
                if (i < i2) {
                    ...
                    int i3 = i2 - 1;
                    bArr[i3] = (byte) (bArr[i3] ^ ISOFileInfo.DATA_BYTES1);
