...
public class Blake2sDigest implements ExtendedDigest {
    ...
    public void update(byte[] bArr, int i, int i2) {
        ...
        if (bArr != null && i2 != 0) {
            ...
            int i10 = i6 - i8;
            System.arraycopy(bArr, i8, this.buffer, 0, i10);
            this.bufferPos += i10;
        }
    }
