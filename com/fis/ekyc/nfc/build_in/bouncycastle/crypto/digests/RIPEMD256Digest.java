...
public class RIPEMD256Digest extends GeneralDigest {
    ...
    private void copyIn(RIPEMD256Digest rIPEMD256Digest) {
        ...
        this.f4H4 = rIPEMD256Digest.f4H4;
    ...
    public int doFinal(byte[] bArr, int i) {
        ...
        unpackWord(this.f4H4, bArr, i + 16);
    ...
    public void processBlock() {
        ...
        int F42 = F4(F313, F316, FF215, F314, this.X[1], 11);
        int F43 = F4(F314, F42, F316, FF215, this.X[9], 12);
        int F44 = F4(FF215, F43, F42, F316, this.X[11], 14);
