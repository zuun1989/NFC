...
public class RIPEMD160Digest extends GeneralDigest {
    ...
    private void copyIn(RIPEMD160Digest rIPEMD160Digest) {
        ...
        this.f3H4 = rIPEMD160Digest.f3H4;
    ...
    public int doFinal(byte[] bArr, int i) {
        ...
        unpackWord(this.f3H4, bArr, i + 16);
        reset();
        return 20;
    }
    ...
    public void processBlock() {
        ...
        this.H3 = this.f3H4 + RL284 + RL318;
        this.f3H4 = this.H0 + RL(((RL282 + f5(RL285, RL283, RL286)) + this.X[13]) - 1454113458, 6) + RL284 + RL316;
