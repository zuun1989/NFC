...
public class SM2Engine {
    ...
    /* renamed from: com.fis.ekyc.nfc.build_in.bouncycastle.crypto.engines.SM2Engine$1  reason: invalid class name */
    public static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$fis$ekyc$nfc$build_in$bouncycastle$crypto$engines$SM2Engine$Mode;

        static {
            int[] iArr = new int[Mode.values().length];
            $SwitchMap$com$fis$ekyc$nfc$build_in$bouncycastle$crypto$engines$SM2Engine$Mode = iArr;
            try {
    ...
    private byte[] encrypt(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        if (AnonymousClass1.$SwitchMap$com$fis$ekyc$nfc$build_in$bouncycastle$crypto$engines$SM2Engine$Mode[this.mode.ordinal()] != 1) {
