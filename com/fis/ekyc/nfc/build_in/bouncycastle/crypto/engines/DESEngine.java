...
public class DESEngine implements BlockCipher {
    ...
    private static final byte[] pc1 = {56, ISO7816.INS_DECREASE, 40, ISO7816.INS_VERIFY, 24, 16, 8, 0, 57, 49, 41, 33, 25, 17, 9, 1, 58, ISO7816.INS_INCREASE, ISO7816.INS_PSO, ISO7816.INS_MSE, 26, 18, 10, 2, 59, 51, 43, 35, 62, 54, 46, 38, IdCardService.SFI_COM, 22, 14, 6, 61, 53, 45, 37, 29, 21, IdCardService.SFI_DG13, 5, 60, ISO7816.INS_DECREASE_STAMPED, ISO7816.INS_UNBLOCK_CHV, ISO7816.INS_CHANGE_CHV, 28, 20, IdCardService.SFI_DG12, 4, 27, 19, IdCardService.SFI_DG11, 3};
    private static final byte[] pc2 = {IdCardService.SFI_DG13, 16, 10, 23, 0, 4, 2, 27, 14, 5, 20, 9, 22, 18, IdCardService.SFI_DG11, 3, 25, 7, IdCardService.SFI_DG15, 6, 26, 19, IdCardService.SFI_DG12, 1, 40, 51, IdCardService.SFI_COM, ISO7816.INS_CHANGE_CHV, 46, 54, 29, 39, ISO7816.INS_INCREASE, ISO7816.INS_UNBLOCK_CHV, ISO7816.INS_VERIFY, 47, 43, ISO7816.INS_DECREASE, 38, 55, 33, ISO7816.INS_DECREASE_STAMPED, 45, 41, 49, 35, 28, 31};
    private static final byte[] totrot = {1, 2, 4, 6, 8, 10, IdCardService.SFI_DG12, 14, IdCardService.SFI_DG15, 17, 19, 21, 23, 25, 27, 28};
    ...
    public void desFunc(int[] iArr, byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i7 = ((i6 >>> 16) ^ i5) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH;
        int i8 = i5 ^ i7;
        int i9 = i6 ^ (i7 << 16);
        ...
        int i44 = i41 ^ i43;
        int i45 = i42 ^ (i43 << 2);
        int i46 = ((i44 >>> 16) ^ i45) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH;
        int i47 = i45 ^ i46;
        int i48 = i44 ^ (i46 << 16);
