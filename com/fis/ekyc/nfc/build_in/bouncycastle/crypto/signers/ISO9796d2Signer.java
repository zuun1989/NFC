...
public class ISO9796d2Signer implements SignerWithRecovery {
    ...
    public byte[] generateSignature() throws CryptoException {
        ...
        if (i9 > 0) {
            ...
            bArr5[0] = IdCardService.SFI_DG11;
            bArr5[0] = (byte) (11 | i4);
        } else {
    ...
    public void updateWithRecoveredMessage(byte[] bArr) throws InvalidCipherTextException {
        ...
        if (((processBlock[0] & ISO7816.INS_GET_RESPONSE) ^ 64) != 0) {
        ...
        } else if (((processBlock[processBlock.length - 1] & IdCardService.SFI_DG15) ^ IdCardService.SFI_DG12) == 0) {
            ...
            int i2 = 0;
            while (i2 != processBlock.length && ((processBlock[i2] & IdCardService.SFI_DG15) ^ 10) != 0) {
                i2++;
            }
            int i3 = i2 + 1;
    ...
    public boolean verifySignature(byte[] bArr) {
        ...
        if (((bArr2[0] & ISO7816.INS_GET_RESPONSE) ^ 64) != 0) {
            return returnFalse(bArr2);
        }
        if (((bArr2[bArr2.length - 1] & IdCardService.SFI_DG15) ^ IdCardService.SFI_DG12) != 0) {
            return returnFalse(bArr2);
        }
        ...
        int i2 = 0;
        while (i2 != bArr2.length && ((bArr2[i2] & IdCardService.SFI_DG15) ^ 10) != 0) {
            i2++;
        }
        int i3 = i2 + 1;
        int digestSize = this.digest.getDigestSize();
        ...
        if ((bArr2[0] & ISO7816.INS_VERIFY) == 0) {
            this.fullMessage = true;
