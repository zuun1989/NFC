...
public final class CryptoServicesRegistrar {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0014, code lost:
        if (defaultSecureRandom != null) goto L_0x001b;
     */
    ...
    public static java.security.SecureRandom getSecureRandom() {
        /*
            ...
            monitor-enter(r0)
            java.security.SecureRandom r1 = defaultSecureRandom     // Catch:{ all -> 0x0009 }
        ...
        L_0x000b:
            ...
            r1.<init>()
            monitor-enter(r0)
            java.security.SecureRandom r2 = defaultSecureRandom     // Catch:{ all -> 0x0019 }
            if (r2 != 0) goto L_0x001b
            defaultSecureRandom = r1     // Catch:{ all -> 0x0019 }
            goto L_0x001b
        L_0x0019:
            r1 = move-exception
            goto L_0x001f
        L_0x001b:
            java.security.SecureRandom r1 = defaultSecureRandom     // Catch:{ all -> 0x0019 }
        ...
        L_0x0021:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fis.ekyc.nfc.build_in.bouncycastle.crypto.CryptoServicesRegistrar.getSecureRandom():java.security.SecureRandom");
    }
    ...
    private static Object[] lookupProperty(Property property) {
        ...
        return (Object[]) map.get(property.name);
    }
