...
public class DHParameters implements CipherParameters {
    ...
    public int hashCode() {
        int i;
        int hashCode = getP().hashCode() ^ getG().hashCode();
        if (getQ() != null) {
            i = getQ().hashCode();
        } else {
            i = 0;
    ...
    public DHParameters(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, int i, int i2, BigInteger bigInteger4, DHValidationParameters dHValidationParameters) {
        ...
        if (i <= bigInteger.bitLength() || Properties.isOverrideSet("com.fis.ekyc.nfc.build_in.bouncycastle.dh.allow_unsafe_p_value")) {
            this.g = bigInteger2;
            this.p = bigInteger;
            this.q = bigInteger3;
            this.m = i;
