            ...
            if (!z && !(asymmetricKeyParameter instanceof X25519PrivateKeyParameters)) {
                ...
                if (asymmetricKeyParameter3 == null) {
                    if (asymmetricKeyParameter2 instanceof X448PrivateKeyParameters) {
                        asymmetricKeyParameter3 = ((X448PrivateKeyParameters) asymmetricKeyParameter2).generatePublicKey();
                    } else {
                        asymmetricKeyParameter3 = ((X25519PrivateKeyParameters) asymmetricKeyParameter2).generatePublicKey();
                    }
