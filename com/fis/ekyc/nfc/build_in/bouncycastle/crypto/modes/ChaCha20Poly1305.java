...
public class ChaCha20Poly1305 implements AEADCipher {
    ...
    /* JADX WARNING: type inference failed for: r8v9, types: [com.fis.ekyc.nfc.build_in.bouncycastle.crypto.CipherParameters] */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void init(boolean r7, com.fis.ekyc.nfc.build_in.bouncycastle.crypto.CipherParameters r8) throws java.lang.IllegalArgumentException {
        /*
            r6 = this;
            boolean r0 = r8 instanceof com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.AEADParameters
            if (r0 == 0) goto L_0x0039
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.AEADParameters r8 = (com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.AEADParameters) r8
            int r0 = r8.getMacSize()
            r1 = 128(0x80, float:1.794E-43)
            if (r1 != r0) goto L_0x0022
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.KeyParameter r0 = r8.getKey()
            byte[] r1 = r8.getNonce()
        ...
        L_0x0022:
            ...
            throw r7
        L_0x0039:
            boolean r0 = r8 instanceof com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ParametersWithIV
            if (r0 == 0) goto L_0x00c4
            r2 = r8
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ParametersWithIV r2 = (com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.ParametersWithIV) r2
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.CipherParameters r8 = r2.getParameters()
            r0 = r8
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.KeyParameter r0 = (com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.KeyParameter) r0
            byte[] r1 = r2.getIV()
            r8 = 0
            r6.initialAAD = r8
        L_0x004e:
        ...
        L_0x0066:
            ...
            byte[] r3 = r6.nonce
            boolean r3 = com.fis.ekyc.nfc.build_in.bouncycastle.util.Arrays.areEqual((byte[]) r3, (byte[]) r1)
            if (r3 == 0) goto L_0x0092
            if (r0 == 0) goto L_0x008a
            byte[] r3 = r6.key
            byte[] r5 = r0.getKey()
            boolean r3 = com.fis.ekyc.nfc.build_in.bouncycastle.util.Arrays.areEqual((byte[]) r3, (byte[]) r5)
        ...
        L_0x009e:
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.engines.ChaCha7539Engine r8 = r6.chacha20
            r0 = 1
            r8.init(r0, r2)
        ...
        L_0x00c4:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fis.ekyc.nfc.build_in.bouncycastle.crypto.modes.ChaCha20Poly1305.init(boolean, com.fis.ekyc.nfc.build_in.bouncycastle.crypto.CipherParameters):void");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public int processBytes(byte[] r17, int r18, int r19, byte[] r20, int r21) throws com.fis.ekyc.nfc.build_in.bouncycastle.crypto.DataLengthException {
        /*
            r16 = this;
            r6 = r16
            r7 = r17
        ...
        L_0x0028:
            ...
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.Mac r1 = r6.poly1305
        ...
        L_0x0066:
            ...
            r5 = r21
            r0.processData(r1, r2, r3, r4, r5)
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.Mac r0 = r6.poly1305
        ...
        L_0x00ba:
            ...
            throw r0
        L_0x00c2:
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.DataLengthException r0 = new com.fis.ekyc.nfc.build_in.bouncycastle.crypto.DataLengthException
        ...
        L_0x00da:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fis.ekyc.nfc.build_in.bouncycastle.crypto.modes.ChaCha20Poly1305.processBytes(byte[], int, int, byte[], int):int");
    }
