...
public class GCMBlockCipher implements AEADBlockCipher {
    ...
    public int processBytes(byte[] r8, int r9, int r10, byte[] r11, int r12) throws com.fis.ekyc.nfc.build_in.bouncycastle.crypto.DataLengthException {
        /*
            r7 = this;
            r7.checkStatus()
            int r0 = r8.length
        ...
        L_0x0073:
            return r0
        L_0x0074:
            com.fis.ekyc.nfc.build_in.bouncycastle.crypto.DataLengthException r8 = new com.fis.ekyc.nfc.build_in.bouncycastle.crypto.DataLengthException
            java.lang.String r9 = "Input buffer too short"
            r8.<init>(r9)
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fis.ekyc.nfc.build_in.bouncycastle.crypto.modes.GCMBlockCipher.processBytes(byte[], int, int, byte[], int):int");
    }
