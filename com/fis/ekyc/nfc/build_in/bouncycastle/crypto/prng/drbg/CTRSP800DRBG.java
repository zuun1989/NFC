...
public class CTRSP800DRBG implements SP80090DRBG {
    ...
    private byte[] Block_Cipher_df(byte[] bArr, int i) {
        ...
        System.arraycopy(K_BITS, 0, bArr7, 0, i5);
        int i6 = 0;
        while (true) {
            int i7 = i6 * blockSize;
        ...
        System.arraycopy(bArr4, i5, bArr8, 0, blockSize);
    ...
    private boolean isTDEA(BlockCipher blockCipher) {
        if (blockCipher.getAlgorithmName().equals("DESede") || blockCipher.getAlgorithmName().equals("TDEA")) {
            return true;
        }
        return false;
    }
    ...
    private void padKey(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i6 = i + 4;
        bArr2[i2 + 4] = (byte) ((bArr[i5] << 4) | ((bArr[i6] & ISO7816.INS_CREATE_FILE) >>> 4));
        int i7 = i + 5;
        bArr2[i2 + 5] = (byte) ((bArr[i6] << 3) | ((bArr[i7] & ISO7816.INS_GET_RESPONSE) >>> 5));
        int i8 = i + 6;
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z) {
        ...
        for (int i2 = 0; i2 <= bArr.length / length; i2++) {
            ...
            if (bArr.length - i3 > length) {
                ...
                i = bArr.length - (this._V.length * i2);
            }
            if (i != 0) {
                addOneTo(this._V);
                this._engine.processBlock(this._V, 0, bArr4, 0);
                System.arraycopy(bArr4, 0, bArr, i3, i);
            }
        }
        CTR_DRBG_Update(bArr3, this._Key, this._V);
        this._reseedCounter++;
