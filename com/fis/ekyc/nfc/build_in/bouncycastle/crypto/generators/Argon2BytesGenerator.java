...
public class Argon2BytesGenerator {
    ...
    private void fillSegment(FillBlock fillBlock, Position position) {
        ...
        while (i2 < this.segmentLength) {
            ...
            if (refLane == position2.lane) {
                z = true;
            } else {
                z = false;
            }
            int refColumn = getRefColumn(position, i2, pseudoRandom, z);
    ...
    private int getRefColumn(Position position, int i, long j, boolean z) {
        ...
        if (position.pass != 0) {
            ...
            int i7 = this.laneLength;
            int i8 = ((position.slice + 1) * i6) % i7;
            if (z) {
                i3 = ((i7 - i6) + i) - 1;
            } else {
                int i9 = i7 - i6;
            ...
            i2 = ((position.slice * this.segmentLength) + i) - 1;
        } else {
            int i10 = position.slice * this.segmentLength;
            if (i != 0) {
                i4 = 0;
            }
            i2 = i10 + i4;
        ...
        return ((int) (((long) i5) + (((long) (i2 - 1)) - ((((long) i2) * ((j2 * j2) >>> 32)) >>> 32)))) % this.laneLength;
    }
    ...
    private boolean isWithXor(Position position) {
        if (position.pass == 0 || this.parameters.getVersion() == 16) {
            return false;
        }
        return true;
    }
    ...
    public static class FillBlock {
        ...
        private void applyBlake() {
            ...
            for (int i3 = 0; i3 < 8; i3++) {
                int i4 = i3 * 2;
                Argon2BytesGenerator.roundFunction(this.Z, i4, i4 + 1, i4 + 16, i4 + 17, i4 + 32, i4 + 33, i4 + 48, i4 + 49, i4 + 64, i4 + 65, i4 + 80, i4 + 81, i4 + 96, i4 + 97, i4 + LDSFile.EF_DG16_TAG, i4 + 113);
            }
        }
