...
import com.fis.ekyc.nfc.build_in.bouncycastle.crypto.params.GOST3410ValidationParameters;
...
public class GOST3410ParametersGenerator {
    ...
    private int procedure_A(int i, int i2, BigInteger[] bigIntegerArr, int i3) {
        ...
        return bigIntegerArr3[i8].intValue();
    }
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (add2.compareTo(bigInteger10.pow(iArr[i6])) != 1) {
                        if (bigInteger10.modPow(bigIntegerArr4[i13].multiply(add.add(BigInteger.valueOf(j5))), bigIntegerArr4[i6]).compareTo(bigInteger9) == 0 && bigInteger10.modPow(add.add(BigInteger.valueOf(j5)), bigIntegerArr4[i6]).compareTo(bigInteger9) != 0) {
                            break;
                        }
                        i14 += 2;
    ...
    private void procedure_Bb(long j, long j2, BigInteger[] bigIntegerArr) {
        ...
        while (true) {
            ...
            while (i2 < 32) {
                int i3 = i2 + 1;
                bigIntegerArr4[i3] = bigIntegerArr4[i2].multiply(bigInteger2).add(bigInteger).mod(TWO.pow(32));
                i2 = i3;
            }
            BigInteger bigInteger5 = new BigInteger("0");
            for (int i4 = i; i4 < 32; i4++) {
                bigInteger5 = bigInteger5.add(bigIntegerArr4[i4].multiply(TWO.pow(i4 * 32)));
            }
            bigIntegerArr4[i] = bigIntegerArr4[32];
            BigInteger bigInteger6 = TWO;
            int i5 = 1024;
            BigInteger add = bigInteger6.pow(1023).divide(bigInteger3.multiply(bigInteger4)).add(bigInteger6.pow(1023).multiply(bigInteger5).divide(bigInteger3.multiply(bigInteger4).multiply(bigInteger6.pow(1024))));
            BigInteger mod = add.mod(bigInteger6);
