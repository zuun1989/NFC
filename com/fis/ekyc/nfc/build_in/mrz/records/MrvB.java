...
public class MrvB extends MrzRecord {
    ...
    public void fromMrz(String str) {
        ...
        this.optional = mrzParser.parseString(new MrzRange(28, 36, 1));
    }

    public String toMrz() {
        return "V<" + MrzParser.toMrz(this.issuingCountry, 3) + MrzParser.nameToMrz(this.surname, this.givenNames, 31) + 10 + MrzParser.toMrz(this.documentNumber, 9) + MrzParser.computeCheckDigitChar(MrzParser.toMrz(this.documentNumber, 9)) + MrzParser.toMrz(this.nationality, 3) + this.dateOfBirth.toMrz() + MrzParser.computeCheckDigitChar(this.dateOfBirth.toMrz()) + this.sex.mrz + this.expirationDate.toMrz() + MrzParser.computeCheckDigitChar(this.expirationDate.toMrz()) + MrzParser.toMrz(this.optional, 8) + 10;
    }

    public String toString() {
        return "MRV-B{" + super.toString() + ", optional=" + this.optional + '}';
    }
}
