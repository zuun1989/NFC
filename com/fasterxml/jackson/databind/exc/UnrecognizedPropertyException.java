...
public class UnrecognizedPropertyException extends PropertyBindingException {
    ...
    public static UnrecognizedPropertyException from(JsonParser jsonParser, Object obj, String str, Collection<Object> collection) {
        ...
        Class<?> cls2 = cls;
        UnrecognizedPropertyException unrecognizedPropertyException = new UnrecognizedPropertyException(jsonParser, String.format("Unrecognized field \"%s\" (class %s), not marked as ignorable", new Object[]{str, cls2.getName()}), jsonParser.getCurrentLocation(), cls2, str, collection);
