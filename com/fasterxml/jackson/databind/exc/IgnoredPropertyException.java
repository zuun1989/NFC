...
public class IgnoredPropertyException extends PropertyBindingException {
    ...
    public static IgnoredPropertyException from(JsonParser jsonParser, Object obj, String str, Collection<Object> collection) {
        ...
        Class<?> cls2 = cls;
        IgnoredPropertyException ignoredPropertyException = new IgnoredPropertyException(jsonParser, String.format("Ignored field \"%s\" (class %s) encountered; mapper configured not to allow this", new Object[]{str, cls2.getName()}), jsonParser.getCurrentLocation(), cls2, str, collection);
