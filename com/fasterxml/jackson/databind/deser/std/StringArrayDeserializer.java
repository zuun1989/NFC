...
public final class StringArrayDeserializer extends StdDeserializer<String[]> implements ContextualDeserializer {
            ...
            try {
                if (jsonParser.nextTextValue() == null) {
                    ...
                    if (currentToken == JsonToken.END_ARRAY) {
                        ...
                        obj = (String) this._nullProvider.getNullValue(deserializationContext);
                    }
                } else {
                    obj = (String) jsonDeserializer.deserialize(jsonParser, deserializationContext);
                }
    ...
    /* JADX WARNING: type inference failed for: r6v2, types: [java.lang.Throwable, com.fasterxml.jackson.databind.JsonMappingException] */
