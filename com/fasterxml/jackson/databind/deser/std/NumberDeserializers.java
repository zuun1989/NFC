            ...
            if (currentTokenId == 6) {
                ...
                try {
                    ...
                    if (_intOverflow(parseLong)) {
                        return (Integer) deserializationContext.handleWeirdStringValue(this._valueClass, trim, String.format("Overflow: numeric value (%s) out of range of Integer (%d - %d)", new Object[]{trim, Integer.valueOf(PKIFailureInfo.systemUnavail), Integer.valueOf(Api.BaseClientBuilder.API_PRIORITY_OTHER)}), new Object[0]);
                    }
