...
public class AsPropertyTypeDeserializer extends AsArrayTypeDeserializer {
    ...
    public Object _deserializeTypedForId(JsonParserSequence jsonParserSequence, DeserializationContext deserializationContext, TokenBuffer tokenBuffer) throws IOException {
        ...
        if (this._typeIdVisible) {
            if (tokenBuffer == null) {
                tokenBuffer = new TokenBuffer(jsonParserSequence, deserializationContext);
            }
            tokenBuffer.writeFieldName(jsonParserSequence.getCurrentName());
