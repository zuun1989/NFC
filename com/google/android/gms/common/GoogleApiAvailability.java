...
import com.dexterous.flutterlocalnotifications.p;
...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public void setDefaultNotificationChannelId(Context context, String str) {
        if (PlatformVersion.isAtLeastO()) {
            Preconditions.checkNotNull(C.a((NotificationManager) Preconditions.checkNotNull(context.getSystemService("notification")), str));
        }
        synchronized (zaa) {
            this.zac = str;
        }
    ...
    public final void zae(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        if (i == 18) {
            ...
            t.e L = new t.e(context).A(true).g(true).p(zae).L(new t.c().o(zad));
            if (DeviceProperties.isWearable(context)) {
                Preconditions.checkState(PlatformVersion.isAtLeastKitKatWatch());
                L.J(context.getApplicationInfo().icon).E(2);
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    L.a(R.drawable.common_full_open_on_phone, resources.getString(R.string.common_open_on_phone), pendingIntent);
                } else {
                    L.n(pendingIntent);
                }
            } else {
                L.J(17301642).N(resources.getString(R.string.common_google_play_services_notification_ticker)).S(System.currentTimeMillis()).n(pendingIntent).o(zad);
            }
            if (PlatformVersion.isAtLeastO()) {
                ...
                if (str2 == null) {
                    ...
                    NotificationChannel a = C.a(notificationManager, str2);
                    String string = context.getResources().getString(R.string.common_google_play_services_notification_channel_name);
                    if (a == null) {
                        E.a(notificationManager, b.a(str2, string, 4));
                    } else if (!string.contentEquals(p.a(a))) {
                        a.setName(string);
                        E.a(notificationManager, a);
                    }
                }
                L.i(str2);
            }
    ...
    public Dialog getErrorDialog(q qVar, int i, int i2) {
        return getErrorDialog(qVar, i, i2, (DialogInterface.OnCancelListener) null);
    }

    public boolean showErrorDialogFragment(Activity activity, int i, c cVar, DialogInterface.OnCancelListener onCancelListener) {
        Dialog zaa2 = zaa(activity, i, (zag) null, onCancelListener, new zac(this, activity, i, cVar));
        if (zaa2 == null) {
            return false;
        }
        zad(activity, zaa2, GooglePlayServicesUtil.GMS_ERROR_DIALOG, onCancelListener);
    ...
    public Dialog getErrorDialog(q qVar, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        return zaa(qVar.requireContext(), i, zag.zac(qVar, getErrorResolutionIntent(qVar.requireContext(), i, "d"), i2), onCancelListener, (DialogInterface.OnClickListener) null);
    }
}
