        ...
        synchronized (this.zzp) {
            try {
                ...
                if (i == 1) {
                    ...
                    ConnectionResult zza3 = gmsClientSupervisor3.zza(new zzo(zzb4, zza2, 4225, this.zza.zzc()), zze4, zze(), getBindServiceExecutor());
                    if (!zza3.isSuccess()) {
                        Log.w("GmsClient", "unable to connect to service: " + this.zza.zzb() + " on " + this.zza.zza());
                        if (zza3.getErrorCode() == -1) {
                            i2 = 16;
                        } else {
                            i2 = zza3.getErrorCode();
                        }
    ...
    public void getRemoteService(IAccountAccessor iAccountAccessor, Set<Scope> set) {
        ...
        if (Build.VERSION.SDK_INT < 31) {
            ...
            if (attributionSource == null) {
                ...
                a = attributionSource.getAttributionTag();
            }
        }
        String str = a;
        int i = this.zzy;
