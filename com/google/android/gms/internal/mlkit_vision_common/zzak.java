...
final class zzak implements f {
    ...
    private static final e zzd = zzaj.zza;
    ...
    public zzak(OutputStream outputStream, Map map, Map map2, e eVar) {
    ...
    private static int zzh(d dVar) {
        zzai zzai = (zzai) dVar.c(zzai.class);
        if (zzai != null) {
            return zzai.zza();
        }
    ...
    private static zzai zzj(d dVar) {
        zzai zzai = (zzai) dVar.c(zzai.class);
        if (zzai != null) {
            return zzai;
        }
    ...
    private final zzak zzk(e eVar, d dVar, Object obj, boolean z) throws IOException {
    ...
    private final zzak zzl(g gVar, d dVar, Object obj, boolean z) throws IOException {
        this.zzi.zza(dVar, z);
    ...
    public final zzak zzd(d dVar, int i, boolean z) throws IOException {
        if (z && i == 0) {
            return this;
        }
        zzai zzj = zzj(dVar);
    ...
    public final zzak zze(d dVar, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        zzai zzj = zzj(dVar);
