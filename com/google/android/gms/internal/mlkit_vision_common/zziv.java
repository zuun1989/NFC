...
public enum zziv implements zzag {
    ...
    ON_DEVICE_SMART_REPLY_DETECT(ISO7816.TAG_SM_EXPECTED_LENGTH),
    ON_DEVICE_SMART_REPLY_CREATE(152),
    ON_DEVICE_SMART_REPLY_CLOSE(ISO7816.TAG_SM_STATUS_WORD),
    ...
    CLOUD_LOGO_CLOSE(93),
    CLOUD_SAFE_SEARCH_CREATE(LDSFile.EF_DG15_TAG),
    CLOUD_SAFE_SEARCH_DETECT(LDSFile.EF_DG16_TAG),
    ...
    CUSTOM_MODEL_RUN(LDSFile.EF_DG6_TAG),
    CUSTOM_MODEL_CREATE(LDSFile.EF_DG7_TAG),
    CUSTOM_MODEL_CLOSE(LDSFile.EF_DG8_TAG),
    CUSTOM_MODEL_LOAD(LDSFile.EF_DG9_TAG),
    ...
    MODEL_DOWNLOAD(100),
    MODEL_UPDATE(LDSFile.EF_DG5_TAG),
