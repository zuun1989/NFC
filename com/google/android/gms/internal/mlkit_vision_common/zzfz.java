...
final class zzfz implements e {
    ...
    static {
        ...
        zzae.zza(1);
        zzb = a.b(zzae.zzb()).a();
        d.b a2 = d.a("multipleObjectsEnabled");
        zzae zzae2 = new zzae();
        zzae2.zza(2);
        zzc = a2.b(zzae2.zzb()).a();
        d.b a3 = d.a("classificationEnabled");
        zzae zzae3 = new zzae();
        zzae3.zza(3);
        zzd = a3.b(zzae3.zzb()).a();
        d.b a4 = d.a("maxPerObjectLabelCount");
        zzae zzae4 = new zzae();
        zzae4.zza(4);
        zze = a4.b(zzae4.zzb()).a();
        d.b a6 = d.a("classificationConfidenceThreshold");
        zzae zzae5 = new zzae();
        zzae5.zza(5);
        zzf = a6.b(zzae5.zzb()).a();
        d.b a7 = d.a("customLocalModelOptions");
        zzae zzae6 = new zzae();
        zzae6.zza(6);
