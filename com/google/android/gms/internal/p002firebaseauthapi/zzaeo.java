...
public final class zzaeo {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:48:0x00db, code lost:
        return new j6.x(zza(r0), r1);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:50:0x00e5, code lost:
        return new j6.q(zza(r0), r1);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static b6.m zza(com.google.android.gms.common.api.Status r3) {
        /*
        ...
        L_0x0100:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzaeo.zza(com.google.android.gms.common.api.Status):b6.m");
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof q) {
            return ((q) exc).a().endsWith("APP_NOT_AUTHORIZED");
        }
        return false;
    }

    public static m zza(Status status, h hVar, String str, String str2) {
        int statusCode = status.getStatusCode();
        if (statusCode != 17012 && statusCode != 17007 && statusCode != 17025) {
            return zza(status);
        }
        return new x(zza(statusCode), zza(zzb(statusCode), status)).d(hVar).e(str);
    }

    public static u zza(FirebaseAuth firebaseAuth, zzaat zzaat, A a) {
        zzu.zza(firebaseAuth);
        zzu.zza(zzaat);
        Pair pair = zza.get(17078);
        return new u((String) pair.first, (String) pair.second, o.P1(zzaat, firebaseAuth, a));
    }
