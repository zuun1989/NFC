...
public final class zzni {
    ...
    private static zznl zza(zznl zznl, zznl zznl2, BigInteger bigInteger, BigInteger bigInteger2) {
        if (zznl.zza()) {
            return zznl2;
        }
        if (zznl2.zza()) {
        ...
        BigInteger bigInteger3 = zznl.zzd;
        BigInteger mod = bigInteger3.multiply(bigInteger3).mod(bigInteger2);
        BigInteger bigInteger4 = zznl2.zzd;
        BigInteger mod2 = bigInteger4.multiply(bigInteger4).mod(bigInteger2);
        BigInteger mod3 = zznl.zzb.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = zznl2.zzb.multiply(mod).mod(bigInteger2);
        BigInteger mod5 = zznl.zzc.multiply(zznl2.zzd).mod(bigInteger2).multiply(mod2).mod(bigInteger2);
        BigInteger mod6 = zznl2.zzc.multiply(zznl.zzd).mod(bigInteger2).multiply(mod).mod(bigInteger2);
        if (!mod3.equals(mod4)) {
            ...
            BigInteger add = zznl.zzd.add(zznl2.zzd);
            ...
            return zza(zznl, bigInteger, bigInteger2);
        }
    }

    private static zznl zza(zznl zznl, BigInteger bigInteger, BigInteger bigInteger2) {
        if (zznl.zzc.equals(BigInteger.ZERO)) {
            return zznl.zza;
        }
        BigInteger bigInteger3 = zznl.zzb;
        BigInteger mod = bigInteger3.multiply(bigInteger3).mod(bigInteger2);
        BigInteger bigInteger4 = zznl.zzc;
        BigInteger mod2 = bigInteger4.multiply(bigInteger4).mod(bigInteger2);
        BigInteger mod3 = mod2.multiply(mod2).mod(bigInteger2);
        BigInteger bigInteger5 = zznl.zzd;
        BigInteger mod4 = bigInteger5.multiply(bigInteger5).mod(bigInteger2);
        BigInteger add = zznl.zzb.add(mod2);
        ...
        BigInteger add3 = zznl.zzc.add(zznl.zzd);
