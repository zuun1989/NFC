...
public final class zzu extends AbstractSafeParcelable {
    ...
    public zzu(@SafeParcelable.Param(id = 2) int i, @SafeParcelable.Param(id = 3) String str, @SafeParcelable.Param(id = 4) String str2, @SafeParcelable.Param(id = 5) int i2, @SafeParcelable.Param(id = 6) Point[] pointArr, @SafeParcelable.Param(id = 7) zzn zzn2, @SafeParcelable.Param(id = 8) zzq zzq2, @SafeParcelable.Param(id = 9) zzr zzr, @SafeParcelable.Param(id = 10) zzt zzt, @SafeParcelable.Param(id = 11) zzs zzs, @SafeParcelable.Param(id = 12) zzo zzo2, @SafeParcelable.Param(id = 13) zzk zzk2, @SafeParcelable.Param(id = 14) zzl zzl2, @SafeParcelable.Param(id = 15) zzm zzm2, @SafeParcelable.Param(id = 16) byte[] bArr, @SafeParcelable.Param(id = 17) boolean z, @SafeParcelable.Param(id = 18) double d) {
        this.zza = i;
        this.zzb = str;
        this.zzo = bArr;
        this.zzc = str2;
