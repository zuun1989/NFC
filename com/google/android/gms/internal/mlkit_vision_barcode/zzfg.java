...
final class zzfg implements f {
    private static final Charset zza = Charset.forName("UTF-8");
    private static final d zzb;
    private static final d zzc;
    private static final e zzd = new zzff();
    ...
    public zzfg(OutputStream outputStream, Map map, Map map2, e eVar) {
    ...
    private static int zzh(d dVar) {
        zzfe zzfe = (zzfe) dVar.c(zzfe.class);
        if (zzfe != null) {
            return zzfe.zza();
        }
    ...
    private static zzfe zzj(d dVar) {
        zzfe zzfe = (zzfe) dVar.c(zzfe.class);
        if (zzfe != null) {
            return zzfe;
        }
    ...
    private final zzfg zzk(e eVar, d dVar, Object obj, boolean z) throws IOException {
    ...
    private final zzfg zzl(g gVar, d dVar, Object obj, boolean z) throws IOException {
        this.zzi.zza(dVar, z);
    ...
    public final zzfg zzd(d dVar, int i, boolean z) throws IOException {
        if (!z || i != 0) {
            zzfe zzj = zzj(dVar);
    ...
    public final zzfg zze(d dVar, long j, boolean z) throws IOException {
        if (!z || j != 0) {
            zzfe zzj = zzj(dVar);
            int ordinal = zzj.zzb().ordinal();
            if (ordinal == 0) {
