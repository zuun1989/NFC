...
final class zzlo extends zzku implements RandomAccess, zzmi, zznt {
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Api.BaseClientBuilder.API_PRIORITY_OTHER - i2 >= i) {
            ...
            System.arraycopy(zzlo.zzb, 0, this.zzb, this.zzc, zzlo.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        zzlo zzlo = (zzlo) obj;
        if (this.zzc != zzlo.zzc) {
            return false;
        }
        double[] dArr = zzlo.zzb;
    ...
    public final zzmi zzg(int i) {
        ...
        if (i >= this.zzc) {
            ...
            return new zzlo(dArr, this.zzc, true);
        }
