...
class zzoe extends AbstractMap {
    ...
    public final Set entrySet() {
        if (this.zze == null) {
            this.zze = new zzod(this, (byte[]) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int i = this.zzb;
        if (i != zzoe.zzb) {
            return entrySet().equals(zzoe.entrySet());
        }
        for (int i2 = 0; i2 < i; i2++) {
            if (!zzd(i2).equals(zzoe.zzd(i2))) {
                return false;
            }
        }
        if (i != size) {
            return this.zzc.equals(zzoe.zzc);
        }
        return true;
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        if (this.zzb == 16) {
            zzob zzob = (zzob) this.zza[15];
            this.zzb = 15;
            zzo().put(zzob.zza(), zzob.getValue());
        }
        Object[] objArr = this.zza;
