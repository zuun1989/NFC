...
final class zzht implements e {
    ...
    static {
        ...
        d.b a3 = d.a("clientLibraryName");
        zzcq zzcq3 = new zzcq();
        zzcq3.zza(3);
        zzd = a3.b(zzcq3.zzb()).a();
        d.b a4 = d.a("clientLibraryVersion");
        zzcq zzcq4 = new zzcq();
        zzcq4.zza(4);
        zze = a4.b(zzcq4.zzb()).a();
        d.b a6 = d.a("minClientLibraryVersion");
        zzcq zzcq5 = new zzcq();
        zzcq5.zza(5);
        zzf = a6.b(zzcq5.zzb()).a();
        d.b a7 = d.a("maxClientLibraryVersion");
        zzcq zzcq6 = new zzcq();
        zzcq6.zza(6);
