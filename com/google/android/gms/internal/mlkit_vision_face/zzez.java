...
final class zzez implements e {
    ...
    static {
        ...
        d.b a3 = d.a("requestedPreviewHeight");
        zzcq zzcq3 = new zzcq();
        zzcq3.zza(3);
        zzd = a3.b(zzcq3.zzb()).a();
        d.b a4 = d.a("requestedPreviewWidth");
        zzcq zzcq4 = new zzcq();
        zzcq4.zza(4);
        zze = a4.b(zzcq4.zzb()).a();
        d.b a6 = d.a("actualPreviewHeight");
        zzcq zzcq5 = new zzcq();
        zzcq5.zza(5);
        zzf = a6.b(zzcq5.zzb()).a();
        d.b a7 = d.a("actualPreviewWidth");
        zzcq zzcq6 = new zzcq();
        zzcq6.zza(6);
