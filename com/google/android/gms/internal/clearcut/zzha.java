...
public final class zzha extends zzfu<zzha> implements Cloneable {
    ...
    public final int hashCode() {
        ...
        int i2 = 1237;
        int hashCode4 = ((((((hashCode2 + hashCode3) * 961) + 1237) * 31) + zzfy.hashCode((Object[]) this.zzbjm)) * 31) + Arrays.hashCode(this.zzbjn);
        zzge.zzd zzd = this.zzbjo;
        ...
        String str6 = this.zzbjx;
        int hashCode11 = ((hashCode10 + (str6 == null ? 0 : str6.hashCode())) * 961) + zzfy.hashCode(this.zzbjz);
        zzge.zzs zzs = this.zzbkb;
        int hashCode12 = ((hashCode11 * 961) + (zzs == null ? 0 : zzs.hashCode())) * 31;
        if (this.zzbkc) {
            i2 = 1231;
        }
