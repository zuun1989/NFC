...
public abstract class zzbn extends zzba {
        ...
        public final void zzo(int i) throws IOException {
            if (!zzbn.zzfy || zzag() < 10) {
                ...
                while ((i & -128) != 0) {
                    ...
                    this.position = i4 + 1;
                    zzfd.zza(bArr3, (long) i4, (byte) ((i & CertificateBody.profileType) | 128));
                    i >>>= 7;
                }
        ...
        public final void zzb(long j) throws IOException {
            if (!zzbn.zzfy || zzag() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.position;
                    this.position = i3 + 1;
                    zzfd.zza(bArr3, (long) i3, (byte) ((((int) j) & CertificateBody.profileType) | 128));
                    j >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
    ...
    public static final class zzd extends zzbn {
        ...
        public final void zzo(int i) throws IOException {
            while ((i & -128) != 0) {
                this.zzgd.put((byte) ((i & CertificateBody.profileType) | 128));
                i >>>= 7;
            }
            try {
        ...
        public final void zzb(long j) throws IOException {
            while ((-128 & j) != 0) {
                this.zzgd.put((byte) ((((int) j) & CertificateBody.profileType) | 128));
                j >>>= 7;
            }
            try {
        ...
        public final void zzo(int i) throws IOException {
            ...
            if (this.zzgi <= this.zzgh) {
                while (true) {
                    ...
                    this.zzgi = j + 1;
                    zzfd.zza(j, (byte) ((i & CertificateBody.profileType) | 128));
                    i >>>= 7;
                }
            } else {
                while (true) {
        ...
        public final void zzb(long j) throws IOException {
            if (this.zzgi <= this.zzgh) {
                while ((j & -128) != 0) {
                    long j2 = this.zzgi;
                    this.zzgi = j2 + 1;
                    zzfd.zza(j2, (byte) ((((int) j) & CertificateBody.profileType) | 128));
                    j >>>= 7;
                }
                long j3 = this.zzgi;
                this.zzgi = 1 + j3;
            ...
            while (true) {
                ...
                if (j4 >= this.zzgg) {
                    ...
                    this.zzgi = j4 + 1;
                    zzfd.zza(j4, (byte) ((((int) j) & CertificateBody.profileType) | 128));
                    j >>>= 7;
                }
            }
        }
