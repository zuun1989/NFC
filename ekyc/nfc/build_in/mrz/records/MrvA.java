...
public class MrvA extends MrzRecord {
    ...
    public MrvA() {
        ...
        this.code1 = 'V';
        this.code2 = MrzParser.FILLER;
        this.code = MrzDocumentCode.TypeV;
    }
    ...
    public void fromMrz(String str) {
        ...
        this.optional = mrzParser.parseString(new MrzRange(28, 44, 1));
    }

    public String toMrz() {
        return "V<" + MrzParser.toMrz(this.issuingCountry, 3) + MrzParser.nameToMrz(this.surname, this.givenNames, 39) + 10 + MrzParser.toMrz(this.documentNumber, 9) + MrzParser.computeCheckDigitChar(MrzParser.toMrz(this.documentNumber, 9)) + MrzParser.toMrz(this.nationality, 3) + this.dateOfBirth.toMrz() + MrzParser.computeCheckDigitChar(this.dateOfBirth.toMrz()) + this.sex.mrz + this.expirationDate.toMrz() + MrzParser.computeCheckDigitChar(this.expirationDate.toMrz()) + MrzParser.toMrz(this.optional, 16) + 10;
    }

    public String toString() {
        return "MRV-A{" + super.toString() + ", optional=" + this.optional + '}';
    }
}
